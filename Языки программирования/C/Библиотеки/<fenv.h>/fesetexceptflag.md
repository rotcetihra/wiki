...
- **Возвращаемое значение при ошибке:** ненулевое значение при ошибке восстановления флагов.
...
- **Связанные функции:** `fegetexceptflag` — сохранение флагов в `fexcept_t`; `fesetenv` — восстановление полной среды (включая округление).
