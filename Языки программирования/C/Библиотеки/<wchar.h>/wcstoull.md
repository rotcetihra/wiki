...
- **Возвращаемое значение при ошибке:** `ULLONG_MAX` при переполнении, `0` при ошибке преобразования.
...
- **Связанные функции:** [[Языки программирования/C/Библиотеки/<wchar.h>/wcstoul|wcstoul]], [[Языки программирования/C/Библиотеки/<wchar.h>/wcstoll|wcstoll]].
