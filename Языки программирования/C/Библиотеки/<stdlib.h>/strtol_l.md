...
[[Языки программирования/C/Библиотеки|Библиотеки]] / [[Языки программирования/C/Библиотеки/<stdlib.h>|<stdlib.h>]] / strtol_l

[[Языки программирования/C/Библиотеки/<stdlib.h>/strtol|Назад]] | [[Языки программирования/C/Библиотеки/<stdlib.h>|Содержание]] | [[Языки программирования/C/Библиотеки/<stdlib.h>/strtold|Вперёд]]
...
- **Возвращаемое значение при ошибке:** Возвращает `0`, если ничего не распознано; при переполнении возвращает крайнее значение типа (`LONG_MAX`/`LONG_MIN` и т. д.).
- **Многопоточность:** Потокобезопасна — использует явную локаль вместо глобальной.
- **Связанные функции:** [[Языки программирования/C/Библиотеки/<stdlib.h>/strtol|strtol]] — стандартная версия (текущая локаль).
...
- **[[Языки программирования/C/Библиотеки/<stdlib.h>/strtol|strtol()]]** — стандартная версия (текущая локаль)
- **[[Языки программирования/C/Библиотеки/<stdlib.h>/strtod_l|strtod_l()]]** — вещественный аналог

## Похожие функции

- [[Языки программирования/C/Библиотеки/<stdlib.h>/strtod_l|strtod_l]] — числа с плавающей точкой
- [[Языки программирования/C/Библиотеки/<stdlib.h>/strtol|strtol]] — стандартная версия
