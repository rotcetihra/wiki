...
[[Языки программирования/C/Библиотеки|Библиотеки]] / [[Языки программирования/C/Библиотеки/<stdlib.h>|<stdlib.h>]] / posix_openpt

[[Языки программирования/C/Библиотеки/<stdlib.h>/posix_memalign|Назад]] | [[Языки программирования/C/Библиотеки/<stdlib.h>|Содержание]] | [[Языки программирования/C/Библиотеки/<stdlib.h>/ptsname|Вперёд]]
...
- **[[Языки программирования/C/Библиотеки/<stdlib.h>/getpt|getpt()]]** — GNU-сокращение без флагов
- `open("/dev/ptmx", ...)` напрямую — Linux, без переносимости

## Похожие функции

- [[Языки программирования/C/Библиотеки/<stdlib.h>/getpt|getpt]] — GNU аналог
