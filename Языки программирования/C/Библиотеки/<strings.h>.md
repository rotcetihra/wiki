...
[[Языки программирования/C/Библиотеки/<string.h>|Назад]] | [[Языки программирования/C/Библиотеки|Содержание]] | [[Языки программирования/C/Глава 11. Многопоточность/1. Создание потоков|Вперёд]]
...
- [[Языки программирования/C/Библиотеки/<strings.h>/bcmp|bcmp]] — сравнение N байт (устаревшая)
- [[Языки программирования/C/Библиотеки/<strings.h>/bcopy|bcopy]] — копирование N байт (устаревшая)
- [[Языки программирования/C/Библиотеки/<strings.h>/bzero|bzero]] — обнуление N байт (устаревшая)
- [[Языки программирования/C/Библиотеки/<strings.h>/ffs|ffs]] — позиция первого установленного бита
- [[Языки программирования/C/Библиотеки/<strings.h>/ffsl|ffsl]] — то же для `long`
- [[Языки программирования/C/Библиотеки/<strings.h>/ffsll|ffsll]] — то же для `long long`
- [[Языки программирования/C/Библиотеки/<strings.h>/index|index]] — первое вхождение символа (устаревшая)
- [[Языки программирования/C/Библиотеки/<strings.h>/rindex|rindex]] — последнее вхождение символа (устаревшая)
- [[Языки программирования/C/Библиотеки/<strings.h>/strcasecmp|strcasecmp]] — сравнение строк без учёта регистра
- [[Языки программирования/C/Библиотеки/<strings.h>/strcasecmp_l|strcasecmp_l]] — то же с явной локалью
- [[Языки программирования/C/Библиотеки/<strings.h>/strncasecmp|strncasecmp]] — сравнение не более N символов без учёта регистра
- [[Языки программирования/C/Библиотеки/<strings.h>/strncasecmp_l|strncasecmp_l]] — то же с явной локалью
