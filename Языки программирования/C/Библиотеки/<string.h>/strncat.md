...
- **Связанные функции:** [[Языки программирования/C/Библиотеки/<string.h>/strcat|strcat]] — дописывание без ограничения длины; [[Языки программирования/C/Библиотеки/<string.h>/strlcat|strlcat]] — безопасная версия с проверкой размера (BSD)
