...
[[Языки программирования/C/Библиотеки|Библиотеки]] / [[Языки программирования/C/Библиотеки/<string.h>|<string.h>]] / strxfrm

[[Языки программирования/C/Библиотеки/<string.h>/strverscmp|Назад]] | [[Языки программирования/C/Библиотеки/<string.h>|Содержание]] | [[Языки программирования/C/Библиотеки/<string.h>/strxfrm_l|Вперёд]]
...
- **Возвращаемое значение при ошибке:** длина преобразованной строки (≥ `n` если результат не поместился)
...
- **Многопоточность:** потокобезопасна, но зависит от глобальной локали (используйте `strxfrm_l()` для явной локали)
- **Связанные функции:** [[Языки программирования/C/Библиотеки/<string.h>/strcoll|strcoll]] — сравнение строк с учётом локали; [[Языки программирования/C/Библиотеки/<string.h>/strcmp|strcmp]] — побайтовое сравнение строк

Если `dest` недостаточно большой (возвращённое значение ≥ `n`), содержимое `dest` не определено.
