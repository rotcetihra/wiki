...
- **Возвращаемое значение при ошибке:** Результат всегда определён для любых конечных и бесконечных аргументов.
- **Многопоточность:** Функция является потокобезопасной.
- **Связанные функции:** [[Языки программирования/C/Библиотеки/<complex.h>/cabs|cabs]] — модуль комплексного числа, [[Языки программирования/C/Библиотеки/<complex.h>/creal|creal]] — действительная часть, [[Языки программирования/C/Библиотеки/<complex.h>/cimag|cimag]] — мнимая часть.
