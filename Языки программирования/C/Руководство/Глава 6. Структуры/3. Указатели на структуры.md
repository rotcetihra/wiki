...
[[Языки программирования/C/Руководство/Глава 6. Структуры|Глава 6. Структуры]] / Указатели на структуры

[[Языки программирования/C/Руководство/Глава 6. Структуры/2. Структуры как элементы структур|Назад]] | [[Языки программирования/C/Руководство/Глава 6. Структуры|Содержание]] | [[Языки программирования/C/Руководство/Глава 6. Структуры/4. Массивы структур|Вперёд]]
...
Здесь определяется указатель p\_kate на переменную kate. И используя указатель, мы можем получить или изменить значения элементов структуры.
