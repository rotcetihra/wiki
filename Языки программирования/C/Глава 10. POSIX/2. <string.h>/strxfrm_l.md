...
[[Языки программирования/C/Глава 10. POSIX|Глава 10. POSIX]] / [[Языки программирования/C/Глава 10. POSIX/2. <string.h>|2. <string.h>]] / strxfrm_l

[[Языки программирования/C/Глава 10. POSIX/2. <string.h>/strverscmp|Назад]] | [[Языки программирования/C/Глава 10. POSIX/2. <string.h>|Содержание]] | [[Языки программирования/C/Глава 11. Многопоточность/1. Создание потоков|Вперёд]]
...
Вариант [[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strxfrm|strxfrm()]] с явной локалью: преобразует строку в «форму сравнения» для правил сортировки заданной локали, чтобы затем сравнивать результаты обычным `strcmp()`. Не зависит от глобальной локали программы и безопасна в многопоточных программах.
...
- **[[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strxfrm|strxfrm()]]** — с глобальной локалью
- **[[Языки программирования/C/Глава 10. POSIX/2. <string.h>/strcoll_l|strcoll_l()]]** — сравнение напрямую (без ключей)
- **[[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strcmp|strcmp()]]** — без локали

## Похожие функции

- [[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strxfrm|strxfrm]] — с глобальной локалью
- [[Языки программирования/C/Глава 10. POSIX/2. <string.h>/strcoll_l|strcoll_l]] — сравнение с явной локалью
