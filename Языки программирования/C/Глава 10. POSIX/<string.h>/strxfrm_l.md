...
[[Языки программирования/C/Глава 10. POSIX|Глава 10. POSIX]] / [[Языки программирования/C/Глава 10. POSIX/<string.h>|<string.h>]] / strxfrm_l

[[Языки программирования/C/Глава 10. POSIX/<string.h>/strverscmp|Назад]] | [[Языки программирования/C/Глава 10. POSIX/<string.h>|Содержание]] | [[Языки программирования/C/Глава 11. Многопоточность/1. Создание потоков|Вперёд]]
...
- **[[Языки программирования/C/Глава 10. POSIX/<string.h>/strcoll_l|strcoll_l()]]** — сравнение напрямую (без ключей)
- **[[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strcmp|strcmp()]]** — без локали

## Похожие функции

- [[Языки программирования/C/Глава 9. Стандартная библиотека C/12. <string.h>/strxfrm|strxfrm]] — с глобальной локалью
- [[Языки программирования/C/Глава 10. POSIX/<string.h>/strcoll_l|strcoll_l]] — сравнение с явной локалью
