...
[[Языки программирования/C/Глава 10. POSIX|Глава 10. POSIX]] / [[Языки программирования/C/Глава 10. POSIX/<stdlib.h>|<stdlib.h>]] / strtol_l

[[Языки программирования/C/Глава 10. POSIX/<stdlib.h>/strtod_l|Назад]] | [[Языки программирования/C/Глава 10. POSIX/<stdlib.h>|Содержание]] | [[Языки программирования/C/Глава 10. POSIX/<stdlib.h>/unlockpt|Вперёд]]
...
- **[[Языки программирования/C/Глава 9. Стандартная библиотека C/11. <stdlib.h>/strtol|strtol()]]** — стандартная версия (текущая локаль)
- **[[Языки программирования/C/Глава 10. POSIX/<stdlib.h>/strtod_l|strtod_l()]]** — вещественный аналог

## Похожие функции

- [[Языки программирования/C/Глава 10. POSIX/<stdlib.h>/strtod_l|strtod_l]] — числа с плавающей точкой
- [[Языки программирования/C/Глава 9. Стандартная библиотека C/11. <stdlib.h>/strtol|strtol]] — стандартная версия
