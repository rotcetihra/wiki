...
[[Языки программирования/C/Глава 10. Стандартная библиотека C|Глава 10. Стандартная библиотека C]] / [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>|<setjmp.h>]] / setjmp

[[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/jmp_buf|Назад]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>|Содержание]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/longjmp|Вперёд]]
...
- [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/longjmp|longjmp]] — восстановление контекста из `jmp_buf`
