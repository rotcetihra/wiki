...
[[Языки программирования/C/Глава 10. Стандартная библиотека C|Глава 10. Стандартная библиотека C]] / [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>|<setjmp.h>]] / longjmp

[[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/setjmp|Назад]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>|Содержание]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<signal.h>/sig_atomic_t|Вперёд]]
...
- [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/setjmp|setjmp]] — сохранение контекста в `jmp_buf`
- [[Языки программирования/C/Глава 10. Стандартная библиотека C/<setjmp.h>/jmp_buf|jmp_buf]] — тип буфера для сохранения контекста
