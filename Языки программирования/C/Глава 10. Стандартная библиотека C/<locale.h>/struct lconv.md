...
[[Языки программирования/C/Глава 10. Стандартная библиотека C|Глава 10. Стандартная библиотека C]] / [[Языки программирования/C/Глава 10. Стандартная библиотека C/<locale.h>|<locale.h>]] / struct lconv

[[Языки программирования/C/Глава 10. Стандартная библиотека C/<inttypes.h>/wcstoumax|Назад]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<locale.h>|Содержание]] | [[Языки программирования/C/Глава 10. Стандартная библиотека C/<locale.h>/LC_ALL|Вперёд]]
...
- [[Языки программирования/C/Глава 10. Стандартная библиотека C/<locale.h>/localeconv|localeconv]] -- функция, заполняющая `struct lconv`
