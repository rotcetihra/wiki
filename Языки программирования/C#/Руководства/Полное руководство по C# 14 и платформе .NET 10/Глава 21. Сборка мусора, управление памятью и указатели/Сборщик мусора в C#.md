...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Руководства|Руководства]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10|Полное руководство по C# 14 и платформе .NET 10]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 21. Сборка мусора, управление памятью и указатели|Сборка мусора, управление памятью и указатели]] / Сборщик мусора в C#

[[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 20. Dynamic Language Runtime/Использование IronPython в .NET|Назад]] | [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 21. Сборка мусора, управление памятью и указатели|Сборка мусора, управление памятью и указатели]] | [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 21. Сборка мусора, управление памятью и указатели/Финализируемые объекты. Метод Dispose|Вперёд]]

**Дата написания:** 05.09.2026

## Сборщик мусора в C#

Ранее в теме  [Типы значений и ссылочные типы](./2.16.php)  мы рассматривали отдельные типы данных 
...
В методе Test создается объект Person. С помощью оператора  new  в куче для хранения объекта CLR выделяет участок памяти. 
...
отработает, место в стеке очищается, а сборщик мусора очищает ранее выделенный под хранение объекта Person участок памяти.
...
Когда сборщик мусора приступает к работе, он сначала анализирует объекты из поколения 0. Те объекты, которые остаются актуальными после очистки, 
...
**Источник:** [https://metanit.com/sharp/tutorial/8.1.php](https://metanit.com/sharp/tutorial/8.1.php)
