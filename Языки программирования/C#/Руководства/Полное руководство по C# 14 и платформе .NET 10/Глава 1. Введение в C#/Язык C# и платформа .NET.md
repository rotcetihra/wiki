...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Руководства|Руководства]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10|Полное руководство по C# 14 и платформе .NET 10]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 1. Введение в C#|Введение в C#]] / Язык C# и платформа .NET

[[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 1. Введение в C#|Введение в C#]] | [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 1. Введение в C#/Первая программа на C# с .NET CLI|Вперёд]]
...
феврале 2002 года. Текущей версией языка является версия C# 14, которая вышла 11 ноября 2025 года вместе с релизом .NET 10.
...
Когда говорят C#, нередко имеют в виду технологии платформы .NET (Windows Forms, WPF, ASP.NET, .NET MAUI). И, наоборот, когда говорят .NET, нередко имеют в виду C#. 
...
- Кроссплатформенность . .NET является переносимой платформой (с некоторыми ограничениями). Например, 
 последняя версия платформы на данный момент - .NET 9 поддерживается на 
...
- Производительность . Согласно ряду тестов веб-приложения на .NET в ряде категорий сильно опережают веб-приложения, 
построенные с помощью других технологий. Приложения на .NET в принципе отличаются высокой производительностью.
...
И текущей версией является расматриваемая в этом руководстве платформа .NET 10.
Поэтому следует различать .NET Framework, который предназначен преимущественно для Windows, и кросплатформенный .NET 10. 
В данном руководстве речь будет идти о C# 14 в связке с .NET 10, поскольку это актуальная платформа.
...
работы программы. В итоге это повышает производительность. В то же время для подобного выполнения приложения на компьютере должна быть установлена платформа .NET.

JIT-компиляция является базовой формой компиляции приложения, но не единственной. В качестве альтернативы инструментарий .NET предоставляет возможности для создания нативного приложения - такого приложения, которое компилируется в машинный код определенной платформы. 
Это так называемая  AOT-компиляция  (AOT = Ahead of Time - компиляция перед выполнением). При такой форме компиляции приложение может запускаться на компьютере без установленного .NET. В то же время 
программа становится непереносимой - мы не можем запустить, например, на Windows, программу, предназначенную для Linux. Однако подобная модель компиляции может увеличить производительность.

По сути это все, что вкратце надо знать о платформе .NET и языке C#. А теперь создадим первое приложение.

**Источник:** [https://metanit.com/sharp/tutorial/1.1.php](https://metanit.com/sharp/tutorial/1.1.php)
