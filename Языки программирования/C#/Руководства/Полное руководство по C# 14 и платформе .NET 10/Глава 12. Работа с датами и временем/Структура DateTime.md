...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Руководства|Руководства]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10|Полное руководство по C# 14 и платформе .NET 10]] / [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 12. Работа с датами и временем|Работа с датами и временем]] / Структура DateTime

[[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 11. Работа со строками/Регулярные выражения|Назад]] | [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 12. Работа с датами и временем|Работа с датами и временем]] | [[Языки программирования/C#/Руководства/Полное руководство по C# 14 и платформе .NET 10/Глава 12. Работа с датами и временем/Форматирование дат и времени|Вперёд]]
...
Свойство  `DateTime.Now`  берет текущую дату и время компьютера,  `DateTime.UtcNow`  - дата и время относительно времени по 
Гринвичу (GMT) и  `DateTime.Today`  - только текущая дата.
...
Консоль высветит значение Tuesday, то есть вторник. Однако, как может быть известно из истории, впервые переход с юлианского календаря на григорианский 
...
**Источник:** [https://metanit.com/sharp/tutorial/19.1.php](https://metanit.com/sharp/tutorial/19.1.php)
