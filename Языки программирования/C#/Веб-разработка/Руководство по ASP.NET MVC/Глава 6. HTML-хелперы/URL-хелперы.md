...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC|Руководство по ASP.NET MVC]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 6. HTML-хелперы|Глава 6. HTML-хелперы]] / URL-хелперы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 6. HTML-хелперы/Генерация ссылок|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 6. HTML-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 7. Tag-хелперы/Введение в tag-хелперы|Вперёд]]
...
```
@Url.Action("Details", "Home", new { name = "Тоm", id = 10 }, null)
```
...
```
<a href='@Url.Action("Details", "Home", new { name = "Тоm", id = 10 }, null)'>Ссылка</a>
```
...
```
@Url.RouteUrl(new { controller = "Home", action = "Details", name = "Tom", id = 10 })
```
...
**Источник:** [https://metanit.com/sharp/aspnetmvc/6.6.php](https://metanit.com/sharp/aspnetmvc/6.6.php)
