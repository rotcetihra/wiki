...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC|Руководство по ASP.NET MVC]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 10. Фильтры|Глава 10. Фильтры]] / Введение в фильтры

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 9. Метаданные и валидация модели/Аннотации данных|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 10. Фильтры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 10. Фильтры/Область действия фильтров|Вперёд]]
...
Фильтры результатов действий: фильтр применяется к результатам методов контроллера, выполняется как до,
...
![Filter Pipeline или конвейер фильтров в ASP.NET Core MVC и C#](https://metanit.com./pics/10.1.png)
...
К примеру, создадим свой фильтр. Для этого добавим в проект папку Filters, в которой будут храниться фильтры. И далее добавим в эту папку новый класс
...
![Определение фильтров в ASP.NET Core MVC и C#](https://metanit.com./pics/10.3.png)
...
![Применение фильтров в ASP.NET Core MVC и C#](https://metanit.com./pics/10.2.png)
...
При обращении к методу Index сработает фильтр FakeNotFoundResourceFilter, который установит результат обработки запроса. И после него никакие другие фильтры
...
**Источник:** [https://metanit.com/sharp/aspnetmvc/10.1.php](https://metanit.com/sharp/aspnetmvc/10.1.php)
