...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC|Руководство по ASP.NET MVC]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 1. Введение в ASP.NET Core MVC|Глава 1. Введение в ASP.NET Core MVC]] / Первый проект на ASP.NET Core MVC в Visual Studio

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 1. Введение в ASP.NET Core MVC/Первый проект на ASP.NET Core MVC с .NET CLI|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 1. Введение в ASP.NET Core MVC|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET MVC/Глава 1. Введение в ASP.NET Core MVC/Добавление MVC в пустой проект|Вперёд]]
...
Для создания проекта на ASP.NET Core MVC мы можем выбрать любой тип проекта на ASP.NET Core и в нем уже добавлять необходимые компоненты.
Однако для упрощения Visual Studio уже по умолчанию предоставляет для этого шаблон ASP.NET Core Web App (Model-View-Controller):
![Проект ASP.NET Core Web App (Model-View-Controller) на языке программирования C#](https://metanit.com./pics/1.1.png)
...
![Первый проект ASP.NET Core Web App (Model-View-Controller) на языке программирования C#](https://metanit.com./pics/1.2.png)


Далее нам надо будет настроить стандартные настройки для ASP.NET Core:
![Настройка проекта ASP.NET Core MVC на языке C#](https://metanit.com./pics/1.3.png)
...
![Структура проекта ASP.NET MVC Core](https://metanit.com./pics/1.4.png)
...
![Первый проект на ASP.NET MVC Core и C#](https://metanit.com./pics/1.5.png)
...
**Источник:** [https://metanit.com/sharp/aspnetmvc/1.2.php](https://metanit.com/sharp/aspnetmvc/1.2.php)
