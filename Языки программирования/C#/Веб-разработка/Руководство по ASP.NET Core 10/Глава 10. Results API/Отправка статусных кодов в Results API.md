...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Глава 10. Results API]] / Отправка статусных кодов в Results API

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Переадресация в Results API|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Отправка файлов в Results API|Вперёд]]
...
Нередко возникает необходимость отправить в ответ на запрос какой-либо статусный код. Например, если пользователь пытается получить
...
статусного кода об успешном выполнении операции. И для этого Results API предоставляет ряд методов.
...
![NotFound и Results API в ASP.NET Core и C#](https://metanit.com./pics/10.6.png)
...
Метод BadRequest() посылает код 400, который говорит о том, что запрос некорректный. В качестве параметра
...
В данном случае если параметр маршрута age меньше 18, то посылаем клиенту статусный код 400 с сообщением "Invalid age". Иначе посылаем некоторое стандартное сообщение
![BadRequest и Results API в ASP.NET Core и C#](https://metanit.com./pics/10.7.png)


Причем опять же посылаемый объект по умолчанию сериализуются в формат json.


### Ok


Метод Ok() посылает статусный код 200, уведомляя об успешном выполнении запроса. В качестве параметра метод
принимает отправляемую информацию:
...
![Ok и Results API в ASP.NET Core и C#](https://metanit.com./pics/10.8.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/10.4.php](https://metanit.com/sharp/aspnet6/10.4.php)
