...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Глава 10. Results API]] / Отправка текста и json в Results API

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Введение в Results API|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Переадресация в Results API|Вперёд]]
...
![Results.Content и отправка текста в Results API в ASP.NET Core и C#](https://metanit.com./pics/10.2.png)
...
![Results.Json и отправка объектов json в Results API в ASP.NET Core и C#](https://metanit.com./pics/10.3.png)


Если надо конкретизировать параметры сериализации в json, то можно использовать второй параметр метода, который представляет тип
...
![Results.Json и настройка сериализации в json в ASP.NET Core и C#](https://metanit.com./pics/10.4.png)
...
![Results.Json и отправка статусного кода в ASP.NET Core и C#](https://metanit.com./pics/10.5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/10.2.php](https://metanit.com/sharp/aspnet6/10.2.php)
