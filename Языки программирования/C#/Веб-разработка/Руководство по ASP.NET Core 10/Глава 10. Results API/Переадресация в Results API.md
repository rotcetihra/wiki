...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Глава 10. Results API]] / Переадресация в Results API

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Отправка текста и json в Results API|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Отправка статусных кодов в Results API|Вперёд]]
...
permanent: указывает, будет ли переадресация постоянной (отправляется статусный код 301) или временной (
отравляется статусный код 302).
...
Метод Redirect() также осуществляет переадресацию и принимает те же параметры, что и `LocalRedirect()`, только адрес для переадресации
может не только локальным, но и внешним:
...
**Источник:** [https://metanit.com/sharp/aspnet6/10.3.php](https://metanit.com/sharp/aspnet6/10.3.php)
