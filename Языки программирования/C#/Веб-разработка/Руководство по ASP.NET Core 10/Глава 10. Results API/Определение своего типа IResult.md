...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Глава 10. Results API]] / Определение своего типа IResult

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API/Отправка файлов в Results API|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 10. Results API|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 11. Web API/Пример приложения Web API|Вперёд]]
...
Встроенные типы Result API покрывают различные ситуации. Однако встроенных типов может оказаться недостаточно. И в этом случае мы можем определить
свой тип IResult.
...
Через конструктор класса получаем отправляемый код html. А в методе `ExecuteAsync()` через параметр типа HttpContext
установливаем заголовок и отправляем html-код.
...
![Создание своего типа IResult для отправки кода html в ASP.NET Core и C#](https://metanit.com./pics/10.13.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/10.6.php](https://metanit.com/sharp/aspnet6/10.6.php)
