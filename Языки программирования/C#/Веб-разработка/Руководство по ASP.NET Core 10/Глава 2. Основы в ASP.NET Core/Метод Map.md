...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core|Глава 2. Основы в ASP.NET Core]] / Метод Map

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core/Создание ветки конвейера. UseWhen и MapWhen|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core/Классы middleware|Вперёд]]
...
Метод Map() применяется для создания ветки конвейера, которая будет обрабатывать запрос по определенному пути. Этот метод реализован как метод расширения
для типа IApplicationBuilder и имеет ряд перегруженных версий. Например:
...
Созданная ветка конвейера содержит два middleware, встраиваемые с помощью методов `Use()` и `Run()`. Вначале получаем текущее время и в
...
![Ответвление конвейера обработки запроса и app.Map в ASP.NET Core и C#](https://metanit.com./pics/2.44.png)
...
![Сопоставление пути запроса с веткой конвейера обработки запрсоа в методе app.Map в ASP.NET Core и C#](https://metanit.com./pics/2.43.png)
...
![Вложенные ветки конвейера обработки запрсоа в методе app.Map в ASP.NET Core и C#](https://metanit.com./pics/2.45.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/2.14.php](https://metanit.com/sharp/aspnet6/2.14.php)
