...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core|Глава 2. Основы в ASP.NET Core]] / Построение конвейера обработки запроса

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core/Классы middleware|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 2. Основы в ASP.NET Core/IWebHostEnvironment и окружение|Вперёд]]
...
Обычно для обработки запроса применяется не один, а несколько компонентов middleware. И в этом случае большую роль может играть порядок их
...
![Организация pipeline в ASP.NET Core и C#](https://metanit.com./pics/2.49.png)
...
`await next.Invoke(context);`, а после завершения обработки последующих компонентов вызывается та часть
кода, которая идет после `await next.Invoke(context);`.
...
![Конвейер обработки запроса в ASP.NET Core и C#](https://metanit.com./pics/2.50.png)
...
![порядок обработки запроса в Middleware в ASP.NET Core и C#](https://metanit.com./pics/2.51.png)


В первом случае, если указан параметр token, то запрос будет обработан RoutingMiddleware:
![Этапы обработки запроса в ASP.NET Core и C#](https://metanit.com./pics/2.52.png)


Иначе пользователь получит ошибку 403:
![Цикл обработки запроса в ASP.NET Core и C#](https://metanit.com./pics/2.53.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/2.16.php](https://metanit.com/sharp/aspnet6/2.16.php)
