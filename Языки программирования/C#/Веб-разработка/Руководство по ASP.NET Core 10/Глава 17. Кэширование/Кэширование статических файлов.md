...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 17. Кэширование|Глава 17. Кэширование]] / Кэширование статических файлов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 17. Кэширование/Сжатие ответа|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 17. Кэширование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 17. Кэширование/Кэширование ответа и OutputCache|Вперёд]]
...
`app.js` и `styles.css`
![Кэширование статических файлов в приложении ASP.NET Core на C# и класс StaticFileResponseContext](https://metanit.com./pics/17.7.png)
...
![Кэширование статических файлов в приложении ASP.NET Core на C#](https://metanit.com./pics/17.5.png)


При повторной отправке запроса браузер будет доставать файлы из кэша:
![Кэширование статических файлов в приложении ASP.NET Core на C#](https://metanit.com./pics/17.6.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/17.4.php](https://metanit.com/sharp/aspnet6/17.4.php)
