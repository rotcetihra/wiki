...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 6. Конфигурация|Глава 6. Конфигурация]] / Проекция конфигурации на классы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 6. Конфигурация/Создание провайдера конфгурации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 6. Конфигурация|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 6. Конфигурация/Передача конфигурации через IOptions|Вперёд]]
...
![Привязка конфигурации json и класса C# в ASP.NET Core](https://metanit.com./pics/6.17.png)
...
![Привязка комплексных объектов из конфигурации json к классам C# в ASP.NET Core](https://metanit.com./pics/6.18.png)
...
![Привязка секции конфигурации к объекту класса C# в ASP.NET Core](https://metanit.com./pics/6.19.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/6.7.php](https://metanit.com/sharp/aspnet6/6.7.php)
