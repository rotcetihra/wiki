...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 14. CORS и кросс-доменные запросы|Глава 14. CORS и кросс-доменные запросы]] / Подключение CORS в приложении

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 13. Аутентификация и авторизация/Создание ограничений для авторизации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 14. CORS и кросс-доменные запросы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 14. CORS и кросс-доменные запросы/Конфигурация CORS|Вперёд]]
...
По умолчанию веб-браузеры в целях безопасности ограничивают ajax-запросы между различными доменами. Однако нередко возникает ситуация, когда необходимо
...
Чтобы задействовать CORS для обработки запроса вызывается метод app.UseCors(). Для конфигурации параметров CORS этот метод
использует делегат, в который передается объект CorsPolicyBuilder. И с помощью этого объекта можно выполнить настройку CORS.
...
Здесь мы будем работать только со статическими файлами. В частности, определим в этом проекте в папке wwwroot
...
![CORS и кроссдоменные запросы в ASP NET Core и C#](https://metanit.com./pics/14.1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/14.1.php](https://metanit.com/sharp/aspnet6/14.1.php)
