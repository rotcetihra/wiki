...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 16. Клиентская разработка|Глава 16. Клиентская разработка]] / Пакетный менеджер Libman

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 16. Клиентская разработка/Бандлинг и минификация|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 16. Клиентская разработка|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 16. Клиентская разработка/Пакетный менеджер NPM|Вперёд]]
...
Для управления клиентскими библиотеками в Visual Studio можно использовать пакетный менеджер Microsoft Library Manager или
сокращенно Libman.


К примеру, возьмем в любой проект ASP.NET Core в Visual Studio. Допустим, для хранения статических файлов библиотек в проекте определена папка
wwwroot/lib. Нажмем на эту папку правой кнопкой мыши:
![менеджер управления пакетами Libman в ASP.NET Core и C#](https://metanit.com./pics/16.8.png)
...
![Library Manager in ASP.NET Core in Visual Studio](https://metanit.com./pics/16.9.png)


Данное окно предоставляет ряд опций для добавления библиотек. Первая опция Provider предоставляет список провайдеров
пакетов. Сейчас доступно четыре провайдера:
...
![добавление библиотек javascript в проект ASP.NET Core и C#](https://metanit.com./pics/16.10.png)
...
![libman.json в Visual Studio в проекте ASP.NET Core и C#](https://metanit.com./pics/16.11.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/16.2.php](https://metanit.com/sharp/aspnet6/16.2.php)
