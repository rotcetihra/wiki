...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 4. Маршрутизация|Глава 4. Маршрутизация]] / Передача зависимостей в конечные точки

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 4. Маршрутизация/Создание ограничений маршрутов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 4. Маршрутизация|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 4. Маршрутизация/Сопоставление запроса с конечной точкой|Вперёд]]
...
Фреймворк ASP.NET Core предоставляет простой и удобный способ для передачи зависимостей в конечные точки. Все добавляемые в коллекцию сервисов приложения зависимости
можно получить через параметры делегата, который отвечает за обработку запроса.
...
![Внедрение зависимостей и получение сервисов в конечных точках в ASP.NET Core и C#](https://metanit.com./pics/3.19.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/3.5.php](https://metanit.com/sharp/aspnet6/3.5.php)
