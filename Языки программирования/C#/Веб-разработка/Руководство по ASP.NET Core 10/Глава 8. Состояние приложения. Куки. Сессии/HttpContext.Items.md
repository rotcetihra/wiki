...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10|Руководство по ASP.NET Core 10]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 8. Состояние приложения. Куки. Сессии|Глава 8. Состояние приложения. Куки. Сессии]] / HttpContext.Items

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 7. Логгирование/Создание провайдера логгирования|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 8. Состояние приложения. Куки. Сессии|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET Core 10/Глава 8. Состояние приложения. Куки. Сессии/Куки|Вперёд]]
...
Приложение ASP.NET Core может хранить некоторое состояние. Это могут быть как какие-то глобальные данные, так и данные, которые непосредственно
относятся к запросу и пользователю. И в зависимости от вида данных, существуют различные способы для их хранения.


Один из простейших способов хранения данных представляет коллекция HttpContext.Items - объект типа
...
После завершения запроса все данные из HttpContext.Items удаляются. Каждый объект в этой коллекции имеет ключ и значение. И с помощью ключей можно управлять объектами коллекции.
...
![хранение данных в HttpContext.Items в ASP.NET Core и C#](https://metanit.com./pics/8.1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet6/8.1.php](https://metanit.com/sharp/aspnet6/8.1.php)
