...
[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC/Подключение и создание базы данных в Entity Framework Core|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC/Операции с моделями. Редактирование и удаление|Вперёд]]
...
А при помощи метода `db.Users.Add()` для данных из объекта user формируется sql-выражение `INSERT`, а метод
...
![Создание модели в Entity Framework ASP.NET Core](https://metanit.com./pics/createmodel.png)


Введем в форму какие-либо данные и нажмем на копку:
![Вывод моделей в Entity Framework в ASP.NET Core](https://metanit.com./pics/indexmodel.png)
...
![Просмотр базы данных в SQL Server Object Explorer](https://metanit.com./pics/serverexplorer.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/12.2.php](https://metanit.com/sharp/aspnet5/12.2.php)
