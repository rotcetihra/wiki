...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC|Глава 17. Работа с данными в Entity Framework в MVC]] / Tag-хелпер пагинации с сортировкой и фильтрацией

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC/Объединение сортировки, фильтрации и пагинации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 17. Работа с данными в Entity Framework в MVC|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Введение в Razor Pages|Вперёд]]
...
![Tag-хелпер для постраничной навигации с сортировкой и фильтрацией в ASP.NET Core MVC](https://metanit.com./pics/paging7.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/12.10.php](https://metanit.com/sharp/aspnet5/12.10.php)
