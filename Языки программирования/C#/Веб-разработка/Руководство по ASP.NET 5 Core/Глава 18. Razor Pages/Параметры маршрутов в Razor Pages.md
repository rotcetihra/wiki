...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Параметры маршрутов в Razor Pages

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Привязка свойств RazorPage к параметрам запроса|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Обработчики страницы|Вперёд]]
...
Кроме получения данных из параметры запроса и из отправленных форм мы также можем получать данные из параметров маршрута. И в данном случае
...
Параметры, которые идут после вопросительного знака в url представляют параметры строки запроса. А данные, которые разделены в url слешами, представляют
...
С помощью свойства `RouteData.Values`, как и в контроллерах MVC, мы можем получить параметры маршрута.
![Параметры маршрута в Razor Pages в ASP.NET Core](https://metanit.com./pics/razorpages13.png)
...
![Получение параметров маршрутов в ASP.NET Core UserPages](https://metanit.com./pics/razorpages14.png)
...
В данном случае параметры id и age должны обязательно представлять число, а параметр name может содержать только алфавитные символы, причем не менее трех символов.
Подробнее про ограничения маршрутов в MVC можно посмотреть в статье [Ограничения маршрутов](11.3.php).
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.5.php](https://metanit.com/sharp/aspnet5/29.5.php)
