...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Подключение к базе данных

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Переадресация и создание ссылок|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Создание и вывод из базы данных|Вперёд]]
...
Рассмотрим создание простейшего CRUD-интерфейса и взаимодействие с БД из Razor Pages. Пусть у нас есть проект для ASP.NET Core по типу
Web Application.
![Проект Razor Pages in ASP.NET Core MVC](https://metanit.com./pics/razorpages1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.9.php](https://metanit.com/sharp/aspnet5/29.9.php)
