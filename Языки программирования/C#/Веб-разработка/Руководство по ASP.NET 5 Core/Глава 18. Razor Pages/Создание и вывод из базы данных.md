...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Создание и вывод из базы данных

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Подключение к базе данных|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Изменение и удаление в базе данных|Вперёд]]
...
Продолжим работу с проектом из прошлой темы, где уже настроено подключение и создана база данных. Теперь добавим в проект в папку Pages новый каталог
People. В этот каталог добавим новую страницу Razor, которую назовем Index.cshtml:
![Взаимодействие с базой данных из Razor Pages](https://metanit.com./pics/razorpages20.png)


После ее добавления в папке Pages/People появятся два файла: Index.cshtml и Index.cshtml.cs.
...
Поскольку в классе Startup контекст данных ApplicationContext добавляется в качестве сервиса, то в конструкторе PageModel, также как и в конструкторе
контроллеров MVC, мы можем получить этот контекст и затем использовать его для взаимодействия с базой данных.
...
Теперь аналогичным образом добавим в папку Pages/People еще одну страницу Razor - Create.cshtml. И вначале изменим
файл Create.cshtml.cs:
...
![проект для RazorPages в ASP.NET Core MVC](https://metanit.com./pics/razorpages23.png)


Запустим проект. Вначале у нас нет объектов в бд, поэтому перейдем к странице Create.cshtml и добавим один объект:
![Добавление в базу данных в Razor Pages](https://metanit.com./pics/razorpages21.png)


И после добавления страница Index отобразит добавленный объект:
![Вывод объектов из базы данных в Razor Pages](https://metanit.com./pics/razorpages22.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.10.php](https://metanit.com/sharp/aspnet5/29.10.php)
