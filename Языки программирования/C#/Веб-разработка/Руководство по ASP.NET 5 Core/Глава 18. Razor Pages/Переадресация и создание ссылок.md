...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Переадресация и создание ссылок

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Возвращение результата|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Подключение к базе данных|Вперёд]]
...
Для переадресации на страницу Razor применяется метод RedirectToPage(). В этот метод передается относительный путь к
странице. При этом передаваемый путь объединяется с путем к текущей странице, из которой вызывается данный метод.


Например, текущая страница расположена по пути Pages/Products/Create.cshtml.
![Переадресация в Razor Pages в ASP.NE Core](https://metanit.com./pics/razorpages32.png)
...
Для генерации адреса на страницу Razor применяется метод Url.Page(). Этот метод имеет ряд перегрузок, позволяющих задать различные параметры.
Некоторые из версий:
...
Параметр `pageName` указывает на путь к странице. Параметр `pageHandler` представляет обработчик, определенный для страницы.
А параметр `values` представляет параметры строки запроса, которые передаются странице.
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.8.php](https://metanit.com/sharp/aspnet5/29.8.php)
