...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Возвращение результата

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Обработчики страницы|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Переадресация и создание ссылок|Вперёд]]
...
Все ранее рассмотренные методы OnGet и OnPost, предназначенные для обработки GET и POST-запросов, ничего не возвращали, то есть имели в качестве возвращаемого типа
...
В реальности данные методы по умолчанию возвращали связанную с классом страницу Razor. Однако иногда возникает необходимость возвратить некоторый результат, например, статусный код ошибки или сделать редирект. И подобные методы, как и
методы контроллеров, также могут возвращать объекты IActionResult. Для этого в классе PageModel определено ряд методов:
...
Большинство этих методов и возвращаемых ими результатов было рассмотрено ранее в теме [Результаты действий контроллеров](https://metanit.com/sharp/aspnet5/5.3.php) и
...
либо статусный код ошибки, либо страницу Razor.
...
Метод OnGet возвращает IActionResult. В зависимости от того, найден ли пользователь, этот IActionResult будет представлять либо NotFoundResult,
либо PageResult. Причем метод Page() возвращает текущую страницу, как если бы у нас был бы просто определен метод OnGet с типом void:
...
![Result Types in Razor Pages in ASP.NET Core](https://metanit.com./pics/razorpages31.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.7.php](https://metanit.com/sharp/aspnet5/29.7.php)
