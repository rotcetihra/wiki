...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Глава 18. Razor Pages]] / Обработчики страницы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Параметры маршрутов в Razor Pages|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 18. Razor Pages/Возвращение результата|Вперёд]]
...
Класс содержит некоторые начальные данные в переменной people - список объектов Person. При стандартном get-запросе в свойство DisplayedPeople передается весь
этот список.
...
![Обработчики в Razor Pages в ASP.NET Core](https://metanit.com./pics/razorpages15.png)
...
![Handlers в Razor Pages в ASP.NET Core](https://metanit.com./pics/razorpages16.png)
...
http://localhost:44306/Person?handler=ByName&name=Tom.
...
![Передача handler через параметр маршрута в Razor Pages](https://metanit.com./pics/razorpages17.png)


### Обработка форм и запросов POST


Подобным образом мы можем использовать обработчики для для обработки запросов POST - посылать данные по адесам, которые отличаются по параметру handler и прочим параметрам строки запроса.
Но кроме того, мы можем задавать явным образом нужный обработчик с помощью параметра asp-page-handler. Например, изменим код PersonModel:
...
![POST handlers in Razor Pages in ASP.NET Core](https://metanit.com./pics/razorpages18.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/29.6.php](https://metanit.com/sharp/aspnet5/29.6.php)
