...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Глава 16. Метаданные и валидация модели]] / Валидация на стороне клиента

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Валидация на стороне сервера|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Tag-хелперы валидации|Вперёд]]
...
Кроме того, в проекте по типу ASP.NET Core Web App (Model-View-Controller) по умолчанию в папке Views/Shared добавляется
...
![Client validation in ASP NET Core MVC](https://metanit.com./pics/validation13.png)
...
![Стилизация ошибок валидации](https://metanit.com./pics/validation10.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/19.4.php](https://metanit.com/sharp/aspnet5/19.4.php)
