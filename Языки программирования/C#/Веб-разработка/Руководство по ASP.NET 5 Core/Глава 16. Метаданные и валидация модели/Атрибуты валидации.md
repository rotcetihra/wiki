...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Глава 16. Метаданные и валидация модели]] / Атрибуты валидации

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Основы валидации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Валидация на стороне сервера|Вперёд]]
...
Рассмотрим атрибуты валидации, которые мы можем применить в приложении на ASP.NET Core.
...
![Атрибут Required в ASP.NET](https://metanit.com./pics/validation3.png)
...
![Атрибут RegularExpression в ASP.NET Core](https://metanit.com./pics/validation4.png)
...
![Атрибут StringLength в ASP.NET Core](https://metanit.com./pics/validation5.png)
...
![Проверка ввода пароля в ASP.NET Core](https://metanit.com./pics/validation6.png)
...
![Удаленная валидация Remote Validation в ASP.NET Core](https://metanit.com./pics/validation12.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/19.2.php](https://metanit.com/sharp/aspnet5/19.2.php)
