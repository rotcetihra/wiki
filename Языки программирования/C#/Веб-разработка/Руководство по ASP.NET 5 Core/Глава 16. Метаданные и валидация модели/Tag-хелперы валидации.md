...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Глава 16. Метаданные и валидация модели]] / Tag-хелперы валидации

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Валидация на стороне клиента|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 16. Метаданные и валидация модели/Создание атрибута валидации. Самовалидация модели|Вперёд]]
...
![ValidationMessageTagHelper и ValidationSummaryTagHelper](https://metanit.com./pics/validationtaghelper.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/10.5.php](https://metanit.com/sharp/aspnet5/10.5.php)
