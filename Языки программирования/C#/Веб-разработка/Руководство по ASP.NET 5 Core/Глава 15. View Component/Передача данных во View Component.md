...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component|Глава 15. View Component]] / Передача данных во View Component

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component/Определение компонента представлений|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component/Генерация контента в View Component|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 27.11.2019
...
В View Component при необходимости можно передавать данные. Во-первых, View Component может принимать некоторые параметры, которые ему передаются при вызове
...
![Параметры в View Component в ASP.NET Core](https://metanit.com./pics/viewcomponent10.png)
...
![Parameters in View Component in ASP.NET Core](https://metanit.com./pics/viewcomponent11.png)


Несмотря на то, что мы вроде равным образом можем обращаться к View Component через метод Component.InvokeAsync или через tag-хелпер,
...
Но рассмотрим следующую ситуацию. View Component устанавливает значения по умолчанию для своих параметров:
...
![Передача параметров в View Component в ASP.NET Core](https://metanit.com./pics/viewcomponent12.png)
...
![Передача сложных данных в View Component в ASP.NET Core MVC](https://metanit.com./pics/viewcomponent5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.11.php](https://metanit.com/sharp/aspnet5/7.11.php)
