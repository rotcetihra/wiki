...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component|Глава 15. View Component]] / Асинхронные операции в View Component

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component/ViewViewComponentResult и представления|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component/ViewComponentContext|Вперёд]]
...
метод `Invoke`, только предназначен для асинхронных операций и обычно возвращает объект Task. При вызове этого метода
...
Для примера возьмем асинхронное считывание из файла. Для этого определим в проекте папку Files, а в нее добавим файл
header.html с каким-нибудь простеньким кодом:
...
![InvokeAsync в ViewComponent в ASP.NET Core](https://metanit.com./pics/viewcomponent8.png)
...
к InvokeAsync мы определим синхронный метод Invoke, например:
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.14.php](https://metanit.com/sharp/aspnet5/7.14.php)
