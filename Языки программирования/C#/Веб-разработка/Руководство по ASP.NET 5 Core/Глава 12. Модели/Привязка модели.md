...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели|Глава 12. Модели]] / Привязка модели

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели/Модели представления View Model|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели/Передача данных в контроллер|Вперёд]]
...
Для обслуживания данного запроса будет выбран метод `Index` контроллера `Home`. Поскольку данный метод принимает параметр с
...
**Источник:** [https://metanit.com/sharp/aspnet5/8.3.php](https://metanit.com/sharp/aspnet5/8.3.php)
