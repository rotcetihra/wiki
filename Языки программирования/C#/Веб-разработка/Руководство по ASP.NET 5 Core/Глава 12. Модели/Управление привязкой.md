...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели|Глава 12. Модели]] / Управление привязкой

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели/Передача данных в контроллер|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 12. Модели/Создание привязчика модели|Вперёд]]
...
![Атрибут BindRequired в ASP.NET Core](https://metanit.com./pics/models7.png)
...
![BindNever в ASP.NET Core](https://metanit.com./pics/models8.png)
...
В качестве параметра в атрибут Bind передается набор свойств объекта User, которые будут участвовать в процессе привязки. Здесь перечислены все свойства.
...
![Атрибут Bind в ASP.NET Core MVC](https://metanit.com./pics/models11.png)
...
[FromBody]: данные берутся из тела запроса. Этот атрибут может применяться, когда в качестве источника данных
...
![Источники привязки модели в ASP.NET Core](https://metanit.com./pics/models9.png)


В коде формы не установлен адрес, поэтому в качестве адреса отправки будет использоваться текущий адрес, то есть `Home/AddUser?Name=Alice&Age=21`, который содержит строку запроса с двумя параметрами. В итоге данные
формы будут игнорироваться:
![Настройка model binding в ASP.NET Core](https://metanit.com./pics/models10.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/8.5.php](https://metanit.com/sharp/aspnet5/8.5.php)
