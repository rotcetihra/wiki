...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 30. CORS и кросс-доменные запросы|Глава 30. CORS и кросс-доменные запросы]] / Конфигурация CORS

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 30. CORS и кросс-доменные запросы/Начало работы с CORS|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 30. CORS и кросс-доменные запросы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 30. CORS и кросс-доменные запросы/Политики CORS|Вперёд]]
...
Если в метод передаются заголовки, отличные от "*", то следует указать по крайней мере три заголовка "accept", "content-type", "origin", а также какие-то свои заголовки,
например, как в данном случае "custom-header".
...
**Источник:** [https://metanit.com/sharp/aspnet5/31.2.php](https://metanit.com/sharp/aspnet5/31.2.php)
