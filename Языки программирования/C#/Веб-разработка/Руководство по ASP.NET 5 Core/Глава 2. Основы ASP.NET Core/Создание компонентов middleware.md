...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core|Глава 2. Основы ASP.NET Core]] / Создание компонентов middleware

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/Методы Map и MapWhen|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/Конвейер обработки запроса|Вперёд]]
...
которые затем добавляются в конвейер с помощью метода `UseMiddleware()`. Например, напишем свой примитивный компонент.
...
![Custom middleware in asp net core](https://metanit.com./pics/custommiddleware2.png)


Если же будет передан корректный токен, то метод `app.UseToken()` передаст управление методу `app.Run()`:
![Создание компонента middleware in asp net core](https://metanit.com./pics/custommiddleware3.png)
...
![Custom middleware in ASP.NET Core](https://metanit.com./pics/custommiddleware1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.4.php](https://metanit.com/sharp/aspnet5/2.4.php)
