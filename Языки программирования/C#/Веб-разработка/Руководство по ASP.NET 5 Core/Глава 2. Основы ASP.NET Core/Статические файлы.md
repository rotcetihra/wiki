...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core|Глава 2. Основы ASP.NET Core]] / Статические файлы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/IWebHostEnvironment и окружение|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/Работа со статическими файлами|Вперёд]]
...
![Добавление html-файла в проект ASP.NET Core](https://metanit.com./pics/2.3.png)


Структура проекта после добавления папки и файла index.html:
![Статические файлы в ASP.NET Core](https://metanit.com./pics/2.31.png)
...
класса `Startup` компонент middleware в виде метода расширения UseStaticFiles():
...
![Обращение к статическим файлам в ASP.NET Core](https://metanit.com./pics/2.7.png)
...
![Изменение пути к webroot в ASP.NET Core](https://metanit.com./pics/2.32.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.5.php](https://metanit.com/sharp/aspnet5/2.5.php)
