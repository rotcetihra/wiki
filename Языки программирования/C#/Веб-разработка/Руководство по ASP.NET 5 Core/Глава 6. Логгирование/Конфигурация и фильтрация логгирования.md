...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Глава 6. Логгирование]] / Конфигурация и фильтрация логгирования

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Фабрика логгера и провайдеры логгирования|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Создание провайдера логгирования|Вперёд]]
...
уровня Warning, а для категории "Microsoft.Hosting.Lifetime" - уровня Information.
...
В данном случае для всех категорий будут логироваться сообщения уровня "Information". Для категории "Microsoft" логируются сообщения уровня
"Warning".
...
для категории "Microsoft" устанавается уровень `LogLevel.Trace`:
...
Можно определять фильтры сразу и в коде C#, и в файле конфигурации. При создании объекта ILogger ILoggerFactory выбирает и применяет одно правило для
каждого провайдера. Выбор нужного правило состоит из ряда этапов:
...
Если на предыдущем шаге не выбрано никаких правил, то применяется настройка `MinimumLevel`. Данную опцию можно опредееленить в коде, например,
при настройке фабрики логгера:
...
Trace и Debug, будут игнорироваться. Установим в качестве минимального уровня Trace, изменив файл Program.cs следующим образом:
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.28.php](https://metanit.com/sharp/aspnet5/2.28.php)
