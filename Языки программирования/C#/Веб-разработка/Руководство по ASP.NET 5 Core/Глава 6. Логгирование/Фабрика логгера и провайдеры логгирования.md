...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Глава 6. Логгирование]] / Фабрика логгера и провайдеры логгирования

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Ведение лога и ILogger|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Конфигурация и фильтрация логгирования|Вперёд]]
...
То есть мы получим тот же вывод сообщений на консоль. Но преимущество использования фабрики логгеров состоит в том, что мы можем дополнительно настроить
...
![Провайдеры логгирования logging providers in ASP.NET Core](https://metanit.com./pics/logger6.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.29.php](https://metanit.com/sharp/aspnet5/2.29.php)
