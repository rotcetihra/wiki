...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Глава 6. Логгирование]] / Создание провайдера логгирования

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Конфигурация и фильтрация логгирования|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 7. Маршрутизация/Основы маршрутизации в ASP.NET Core|Вперёд]]
...
`BeginScope`: этот метод возвращает объект IDisposable, который представляет некоторую область видимости для логгера. В данном случае нам
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.27.php](https://metanit.com/sharp/aspnet5/2.27.php)
