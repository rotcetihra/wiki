...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Глава 6. Логгирование]] / Ведение лога и ILogger

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 5. Состояние приложения. Куки. Сессии/Сессии|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 6. Логгирование/Фабрика логгера и провайдеры логгирования|Вперёд]]
...
![](https://metanit.com./pics/logger2.png)
...
![Тестирование логгера в ASP.NET Core](https://metanit.com./pics/logger3.png)
...
![Категория логгирования в ASP.NET Core](https://metanit.com./pics/logger7.png)
...
![Уровни логгирования в ASP.NET Core](https://metanit.com./pics/logger5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.10.php](https://metanit.com/sharp/aspnet5/2.10.php)
