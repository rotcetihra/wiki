...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core|Глава 1. Введение в ASP.NET Core]] / Начало работы с ASP.NET Core

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core/ASP.NET Core - новая эпоха в развитии ASP.NET|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core/Проект ASP.NET Core в Visual Studio for Mac|Вперёд]]
...
Программу для установки Visual Studio 2019 можно загрузить со страницы [https://www.visualstudio.com/downloads/](https://www.visualstudio.com/downloads/).
...
для создания приложений на ASP.NET Core. В рамках этого руководства будет использоваться бесплатный выпуск VS 2019 Community.
...
![Установка ASP.NET для Visual Studio 2019](https://metanit.com./pics/1.6.png)
...
![Установка .NET Core для Visual Studio 2019](https://metanit.com./pics/1.7.png)
...
![Создание первого проекта ASP.NET Core](https://metanit.com./pics/1.1.png)


На следующем шаге дадим какое-нибудь имя проекту, например, HelloApp, и определим для него местоположение на жестком диске:
![Первый проект ASP.NET Core 5.0](https://metanit.com./pics/1.8.png)


После этого отобразится окно выбора шаблона нового приложения:
![Типы проектов ASP.NET Core](https://metanit.com./pics/1.2.png)
...
![Начало работы с ASP.NET Core](https://metanit.com./pics/1.3.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/1.2.php](https://metanit.com/sharp/aspnet5/1.2.php)
