...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core|Глава 1. Введение в ASP.NET Core]] / Проект ASP.NET Core в Visual Studio for Mac

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core/Начало работы с ASP.NET Core|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 1. Введение в ASP.NET Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/Запуск приложения. Класс Program|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 21.06.2017
...
Также создавать приложения на ASP.NET Core мы можем в Visual Studio for Mac. Для этого нам надо сначала загрузить установщик данной среды
разработки со страницы [https://www.visualstudio.com/ru/downloads/](https://www.visualstudio.com/ru/downloads/).


После загрузки запустим программу установки и на первом этапе нам надо обязательно указать опцию .NET Core:
![Установка Visual Studio for Mac](https://metanit.com./pics/mac6.png)


После установки откроем Visual Studio for Mac и для создания нового проекта нажмем на кнопку New Project...:
![ASP.NET Core in Visual Studio for Mac](https://metanit.com./pics/mac1.png)


Далее нам откроется окно выбора шаблона проекта. В левой части окна нам надо выбрать
 .NET Core -> App. После этого в центральной части появятся типы проектов. Для веба здесь
 представлены все те же типы проектов, что и в Windows-версии Visual Studio:
...
![Создание проекта ASP.NET Core в Visual Studio for Mac](https://metanit.com./pics/mac2.png)


Далее в следующем окне укажем имя проекта и его расположение на жестком диске. Пусть проект называется
 HelloApp:
![ASP.NET Core на MacOS](https://metanit.com./pics/mac3.png)


После этого Visual Studio создаст новый проект. Как и в версии для Windows, проект имеет два файла:
 Program.cs, в котором происходит запуск приложения, и Startup.cs, где определен класс Startup c логикой обработки запроса.


Класс Startup уже имеет некоторую базовую логику для обработки запроса, суть которой заключается в отправке пользователю
 в ответ на запрос строки "Hello World". Поэтому запустим проект, нажав на черную стрелку над структурой проекта:

![Запуск приложения ASP.NET Core на MacOS](https://metanit.com./pics/mac4.png)


И после запуска в браузере по умолчанию отобразится выше указанная строка:
![Первое приложение ASP.NET Core на MacOS](https://metanit.com./pics/mac5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/1.3.php](https://metanit.com/sharp/aspnet5/1.3.php)
