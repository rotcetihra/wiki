...
![Тестирование контроллера Web API в ASP.NET Core](https://metanit.com./pics/webapi8.png)
...
Аргумент `-Body` в этой команде указывает на тело запроса - тот объект, который будет отправляться на сервер. В моем случае это объект
класса User, поэтому все его значения имеют ключи, которые соответствуют названиям свойств класса User.
Кроме того, указываем с помощью флага `ConvertTo-Json`, что объект будет отправляться в формате JSON.
А дополнительный аргумент `-ContentType` устанавливает в запросе заголовок `Content-Type`. В итоге эта команда возвратит
следующий результат:
...
![Тестирование POST запросов в Visual Studio](https://metanit.com./pics/webapi9.png)
...
![Тестирование PUT запросов в Visual Studio](https://metanit.com./pics/webapi10.png)
...
![Тестирование DELETE запросов в Visual Studio](https://metanit.com./pics/webapi11.png)


### Fiddler


Теперь рассмотрим, как использовать [Fiddler](http://www.telerik.com/fiddler). Загрузим установочный пакет по ссылке и установим.
...
![Тестирование запросов в Fiddler](https://metanit.com./pics/fiddler1.png)
...
![Fiddler в ASP.NET Core Web API](https://metanit.com./pics/fiddler2.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/23.3.php](https://metanit.com/sharp/aspnet5/23.3.php)
