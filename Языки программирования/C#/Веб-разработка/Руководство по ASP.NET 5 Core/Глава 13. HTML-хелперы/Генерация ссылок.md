...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы|Глава 13. HTML-хелперы]] / Генерация ссылок

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы/Шаблонные хелперы|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы/URL-хелперы|Вперёд]]
...
Кроме хелперов форм и шаблонных хелперов в ASP.NET Core MVC также имеется ряд методов, которые применяются для генерации исходящих
адресов в приложении, например, при выводе их в представлении.
...
Например, возьмем стандартный маршрут default, который определен в классе Startup:
...
**Источник:** [https://metanit.com/sharp/aspnet5/9.5.php](https://metanit.com/sharp/aspnet5/9.5.php)
