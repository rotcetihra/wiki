...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы|Глава 13. HTML-хелперы]] / Шаблонные хелперы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы/Строго типизированные хелперы|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы/Генерация ссылок|Вперёд]]
...
![Html.Display в ASP.NET Core](https://metanit.com./pics/htmlhelper6.png)
...
![Html.EditorFor в ASP.NET Core](https://metanit.com./pics/htmlhelper7.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/9.4.php](https://metanit.com/sharp/aspnet5/9.4.php)
