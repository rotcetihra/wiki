...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 32. React.JS|Глава 32. React.JS]] / Взаимодействие React.JS и ASP.NET Core

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 32. React.JS/Подключение React в ASP.NET Core|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 32. React.JS|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 33. Дополнительные статьи/Отправка email в ASP.NET Core|Вперёд]]
...
Продолжим работу с проектом из прошлой темы и рассмотрим непосредственно взаимодействие ASP.NET Core и React.JS.
Для этого используем контроллеры Web API.
...
Для управления данными здесь применяются три метода: `Get()` возвращает список объектов, `Post` добавляет один объект и
`Delete()` удаляет объект по id.


В итоге финальный проект будет выглядеть следующим образом:
![React in ASP.NET Core 3](https://metanit.com./pics/react7.png)
...
Здесь определен компонент PhonesList, который выводит список объектов. Для вывода каждого отдельного объекта предназначен компонент Phone.
Для создания формы добавления нового объекта используется компонент PhoneForm.
...
`componentDidMount()`, в котором производится загрузка начальных данных.
...
мы можем получать этот объект и уже в самом компоненте добавлять или удалять его из массива phones, тем самым снизив количество запросов и объем передаваемых данных.
...
![Использование React JS в ASP.NET Core Web API](https://metanit.com./pics/react5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/25.2.php](https://metanit.com/sharp/aspnet5/25.2.php)
