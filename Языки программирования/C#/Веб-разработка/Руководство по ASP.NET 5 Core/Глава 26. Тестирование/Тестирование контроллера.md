...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование|Глава 26. Тестирование]] / Тестирование контроллера

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование/Фреймворк Moq и moq-объекты|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 27. URL Rewriting/Введение в URL Rewriting|Вперёд]]
...
Для post-версии метода AddUser контроллера HomeController существуют два варианта событий. При валидной модели она добавляется в репозиторий, и
происходит передаресация на метод Index:
...
В случае переадресации возвращаемым типом должен быть RedirectToActionResult. Его свойство ActionName указывает на метод для переадресации - он должен представлять
метод Index.
...
подобные методы, в классе Mock определен метод Verify. Так, в данном случае мы верифицируем, что метод Create у репозитория точно был вызван:
...
Стоит отметить, что здесь в тесте не будет работать проверка `if(ModelState.IsValid)`, потому что в тесте не учитывается механизм привязки модели,
...
![Тестирование в ASP.NET Core и Moq](https://metanit.com./pics/unittest9.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/22.5.php](https://metanit.com/sharp/aspnet5/22.5.php)
