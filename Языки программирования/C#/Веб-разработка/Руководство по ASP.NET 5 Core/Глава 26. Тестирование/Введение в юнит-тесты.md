...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование|Глава 26. Тестирование]] / Введение в юнит-тесты

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения/Установка приложения в виде службы Windows|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование/Создание проекта юнит-тестов. Добавление xUnit|Вперёд]]
...
(опять же выводится текст зеленого цвета), то данный цикл часто называют _красным/зеленым циклом_.
...
**Источник:** [https://metanit.com/sharp/aspnet5/22.1.php](https://metanit.com/sharp/aspnet5/22.1.php)
