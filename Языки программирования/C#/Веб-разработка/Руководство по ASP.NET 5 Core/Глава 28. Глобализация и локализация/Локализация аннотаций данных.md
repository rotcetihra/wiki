...
Для локализации аннотаций данных применяется ранее рассмотренный в прошлых темах сервис IStringLocalizer<T>. И также все необходимые
ресурсы локализации определяются с помощью файлов ресурсов. Посмотрим на примере.
...
Это вполне обычная модель, к которой применяются аннотации данных. Но в данном случае значение ErrorMessage в атрибутах Required/Range/StringLength рассматривается
...
И через эти ресурсы мы можем управлять локализацией аннотаций.


Теперь собственно определим файлы ресурсов. К наименованию файлов ресурсов для моделей применяются те же правила, что и к наименованию файлов ресурсов для
...
ViewModels/ProductViewModel.cs, поэтому файлы ресурсов для нее могут располагаться по следующим путям:
...
![Локализация аннотаций данных в ASP.NET Core](https://metanit.com./pics/localization16.png)
...
![Аннотации данных и файлы ресурсов в ASP.NET Core](https://metanit.com./pics/localization17.png)


И файл ресурсов для англоязычной локали:
![Аннотации данных и локализация в ASP.NET Core MVC](https://metanit.com./pics/localization18.png)
...
![](https://metanit.com./pics/localization19.png)


Теперь установим англоязычную локаль:
![](https://metanit.com./pics/localization20.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/28.6.php](https://metanit.com/sharp/aspnet5/28.6.php)
