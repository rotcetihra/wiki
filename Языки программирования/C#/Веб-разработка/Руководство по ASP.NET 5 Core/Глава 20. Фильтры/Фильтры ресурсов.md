...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры|Глава 20. Фильтры]] / Фильтры ресурсов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры/Передача параметров в фильтры и установка зависимостей|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры/Фильтры действий|Вперёд]]
...
Фильтр ресурсов, как правило, применяется для переопределения результата действия. Это может быть полезно, например, в ситуации с кэшированием:
...
непосредственно контроллеру или странице Razor Page.
...
**Источник:** [https://metanit.com/sharp/aspnet5/18.2.php](https://metanit.com/sharp/aspnet5/18.2.php)
