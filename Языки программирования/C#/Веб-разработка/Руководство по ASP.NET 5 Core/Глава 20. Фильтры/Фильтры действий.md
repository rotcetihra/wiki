...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры|Глава 20. Фильтры]] / Фильтры действий

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры/Фильтры ресурсов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 20. Фильтры/Фильтры результатов|Вперёд]]
...
![Action Filters in ASP.NET Core MVC](https://metanit.com./pics/filters4.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/18.3.php](https://metanit.com/sharp/aspnet5/18.3.php)
