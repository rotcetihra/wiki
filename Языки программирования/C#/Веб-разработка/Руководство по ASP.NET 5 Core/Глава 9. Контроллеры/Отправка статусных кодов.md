...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Глава 9. Контроллеры]] / Отправка статусных кодов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Переадресация|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Отправка файлов|Вперёд]]
...
Иногда возникает необходимость отправить в ответ на запрос какой-либо статусный код.
...
И фреймворк ASP.NET Core MVC предоставляет множество различных классов, которые можно использовать для отправки статусного кода.
...
![NotFoundResult и ошибка 404 в ASP.NET MVC Core](https://metanit.com./pics/httpnotfound.png)
...
![Статусные коды в ASP.NET Core](https://metanit.com./pics/controllers8.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/5.6.php](https://metanit.com/sharp/aspnet5/5.6.php)
