...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Глава 9. Контроллеры]] / Отправка файлов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Отправка статусных кодов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Переопределение контроллеров|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 18.11.2019
...
Для примера добавим в корень проекта папку Files, в которой находится файл book.pdf. И также
добавим в папку wwwroot папку Files, в которой находится файл hello.txt:
![Отправка файла по физическому пути в ASP.NET Core MVC 6](https://metanit.com./pics/physicalfileresult.png)
...
Чтобы получить полный физический путь каталога относительно проекта, воспользуемся сервисом IWebHostEnvironment. Он автоматически передается
в контроллер, и через конструктор контроллера мы его можем получить. Свойство ContentRootPath данного сервиса указывает на
физический путь к каталогу проекта.


И, при обращении, например, по пути _Home/GetFile_ нам будет предложено сохранить данный файл на локальном компьютере.
...
**Источник:** [https://metanit.com/sharp/aspnet5/5.7.php](https://metanit.com/sharp/aspnet5/5.7.php)
