...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Глава 9. Контроллеры]] / ContentResult и JsonResult

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Результаты действий|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Переадресация|Вперёд]]
...
![ContentResult в ASP.NET MVC Core](https://metanit.com./pics/controllers5.png)
...
![Отправка JSON в ASP.NET MVC Core](https://metanit.com./pics/json.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/5.4.php](https://metanit.com/sharp/aspnet5/5.4.php)
