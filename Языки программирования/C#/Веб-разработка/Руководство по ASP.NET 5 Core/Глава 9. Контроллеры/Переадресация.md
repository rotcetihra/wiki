...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Глава 9. Контроллеры]] / Переадресация

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/ContentResult и JsonResult|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Отправка статусных кодов|Вперёд]]
...
В ASP.NET Core MVC для создания переадресации используются классы RedirectResult,
...
В данном случае идет переадресация на локальный адрес - методу About контроллера Home. Причем обращаю внимание на знак тильды в начале пути "~". В ASP.NET
...
при обращении к адресу Home/Index в данном случае будет идти переадресация на ресурс Home/Home/About. Поэтому рекомендую всегда использовать в начале локального адреса тильду.
...
Area. В прицнипе тут можно было бы не использовать название контроллера, так как Index и Area находятся в одном контроллере.
...
Поэтому в метод RedirectToRoute передается название "default". В этом маршруте есть параметры controller, action, которые устанавливаются в анонимном объекте.
Ну и также передаются параметры altitude и height, которые принимает метод Area.
...
**Источник:** [https://metanit.com/sharp/aspnet5/5.5.php](https://metanit.com/sharp/aspnet5/5.5.php)
