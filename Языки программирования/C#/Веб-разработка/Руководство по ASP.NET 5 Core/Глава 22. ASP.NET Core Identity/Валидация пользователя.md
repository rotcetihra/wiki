...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Глава 22. ASP.NET Core Identity]] / Валидация пользователя

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Валидация пароля|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Управление ролями|Вперёд]]
...
![Валидация пользователя в ASP.NET Core](https://metanit.com./pics/password4.png)
...
![UserOptions в ASP.NET Core](https://metanit.com./pics/password3.png)
...
![Создание валидатора пользователя в ASP.NET Core](https://metanit.com./pics/password5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/16.10.php](https://metanit.com/sharp/aspnet5/16.10.php)
