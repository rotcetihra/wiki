...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Глава 22. ASP.NET Core Identity]] / Введение в ASP.NET Core Identity

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 21. Аутентификация и авторизация/JWT-токены|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Основные классы в ASP.NET Core Identity|Вперёд]]
...
учетные записи внешних провайдеров, таких как Google, Microsoft, Twitter и других.
...
![ASP.NET Core Identity в Visual Studio](https://metanit.com./pics/identity1.png)
...
![ASP.NET Core Identity и тип аутентификации](https://metanit.com./pics/identity8.png)
...
![ASP NET Core Idenity 2.1](https://metanit.com./pics/identity9.png)
...
![Scaffold ASP.NET Core Identity](https://metanit.com./pics/identity10.png)


Далее в открывшемся окне выберем Idenity:
![Добавление в проект ASP.NET Core Identity](https://metanit.com./pics/identity11.png)


Затем отроется окно, где необходимо указать, какой именно функционал будет добавлен. Здесь очень много различных опций:
![ASP.NET Core Identity Razor Pages](https://metanit.com./pics/identity12.png)
...
![](https://metanit.com./pics/identity13.png)
...
![](https://metanit.com./pics/identity6.png)


Запустим проект на выполнение. И в меню веб-страницы мы увидим дополнительные пункты для регистрации и входа на сайт:
![Create Application with ASP.NET Core Identity](https://metanit.com./pics/identity4.png)
...
![Регистрация в ASP.NET Core Identity](https://metanit.com./pics/identity5.png)
...
![Подтверждение регистрации в ASP.NET Core Identity](https://metanit.com./pics/identity16.png)
...
![Login in ASP.NET Core Identity](https://metanit.com./pics/identity14.png)
![Вход в систему ASP.NET Core MVC Identity](https://metanit.com./pics/identity15.png)
...
![](https://metanit.com./pics/identity7.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/16.1.php](https://metanit.com/sharp/aspnet5/16.1.php)
