...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Глава 22. ASP.NET Core Identity]] / Инициализация БД ролями и пользователями

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Управление ролями|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Бандлинг и минификация|Вперёд]]
...
Нередко возникает необходимость, чтобы база данных к моменту первого обращения приложения уже содержала начальные
данные, например, базовые роли и учетную запись администратора.
...
В классе определен метод `InitializeAsync()`, который добавляет в базу данных две роли - "admin" и "user", а также одного пользователя -
...
Для краткости все данные (логин и пароль администратора) здесь определены в коде, но естественно можно указать значения и в файле конфигурации и затем передавать в
метод.
...
**Источник:** [https://metanit.com/sharp/aspnet5/16.12.php](https://metanit.com/sharp/aspnet5/16.12.php)
