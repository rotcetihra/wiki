...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Глава 22. ASP.NET Core Identity]] / Управление пользователями

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Авторизация пользователей в Identity|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Изменение пароля|Вперёд]]
...
А в папку Views добавим подкаталог Users для представлений контроллера. Далее определим в ней представление
Index.cshtml для вывода пользователей:
...
![Администрирование в ASP.NET Core Identity](https://metanit.com./pics/customidentity11.png)
...
![Управление пользователями в ASP.NET Core Identity](https://metanit.com./pics/customidentity10.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/16.7.php](https://metanit.com/sharp/aspnet5/16.7.php)
