...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Глава 22. ASP.NET Core Identity]] / Регистрация и создание пользователей в Identity

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Добавление Identity в проект с нуля|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Авторизация пользователей в Identity|Вперёд]]
...
Пользователи в приложении представлены классом User, который наследует множество свойств. Однако нам необязательно всех их устанавливать. Достаточно
установить ключевые свойства вроде логина и пароля. Для этого лучше воспользоваться вспомогательной моделью,
которая установит все необходимые свойства.


Итак, добавим в проект новую папку, которую назовем ViewModels. Затем в этой папке определим новый класс RegisterViewModel, который будет
представлять регистрирующегося пользователя:
...
Для работы с учетными записями пользователей добавим в папку Controllers новый контроллер AccountController
и определим в нем метод для регистрации пользователей:
...
по управлению пользователями - `UserManager` и сервис `SignInManager`, который позволяет аутентифицировать пользователя и устанавливать или удалять его куки.
...
Данный метод возвращает объект `IdentityResult`, с помощью которого можно узнать успешность выполненной операции. Вполне возможно, что переданные значения
...
Для представлений этого контроллера в каталоге Views определим подкаталог Account, в который добавим новое представление Register.cshtml.
...
![Структура проекта в ASP.NET Identity Core](https://metanit.com./pics/customidentity7.png)


Запустим приложение и обратимся к действию регистрации. Введем какие-нибудь данные:
![Регистрация в ASP.NET Core Identity](https://metanit.com./pics/customidentity5.png)
...
![Добавление базы данных в ASP.NET Identity Core](https://metanit.com./pics/customidentity3.png)


А в самой базе данных в таблице dbo.AspNetUsers мы сможем увидеть добавленного пользователя.
![Добавление пользователя в ASP.NET Core Identity](https://metanit.com./pics/customidentity6.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/16.3.php](https://metanit.com/sharp/aspnet5/16.3.php)
