...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Глава 23. Клиентская разработка]] / Пакетный менеджер NPM

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Менеджер Libman|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Gulp|Вперёд]]
...
![NPM Configuration File in ASP.NET Core](https://metanit.com./pics/npm1.png)
...
![Пакетный менеджер NPM в ASP.NET Core](https://metanit.com./pics/npm2.png)
...
![Подключение к node_modules в ASP.NET Core](https://metanit.com./pics/npm3.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/13.5.php](https://metanit.com/sharp/aspnet5/13.5.php)
