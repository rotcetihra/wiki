...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Глава 23. Клиентская разработка]] / Менеджер Libman

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Бандлинг и минификация|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Пакетный менеджер NPM|Вперёд]]
...
Начиная с версии 15.8 в Visual Studio была добавлена такая функциональность как Microsoft Library Manager или
сокращенно Libman. Этот менеджер позволяет управлять пакетами клиентских библиотек и в
некотором смысле может рассматриваться как замена безвозвратно ушедшему от нас пакетному менеджеру Bower.


К примеру, возьмем в любой проект ASP.NET Core в Visual Studio (начиная с версии 15.8) и в структуре проекта
нажмем на узел wwwroot/lib правой кнопкой мыши:
![Libman in ASP.NET Core](https://metanit.com./pics/libman1.png)
...
![Library Manager in ASP.NET Core in Visual Studio](https://metanit.com./pics/libman2.png)


Данное окно предоставляет ряд опций для добавления библиотек. Первая опция Provider предоставляет список провайдеров
пакетов. Сейчас доступно три провайдера:
...
Второе поле - поле Library предназначено для ввода названия библиотеки. При вводе нескольких символов появится список подходящих результатов,
из которого можно выбрать нужную библиотеку.
![](https://metanit.com./pics/libman3.png)
...
Include all library files указывает, что добавляться будут все файлы. И в поле ниже мы можем увидеть
список всех добавляемых файлов
...
![libman.json in Visual Studio](https://metanit.com./pics/libman4.png)
...
Узел libraries содержит набор добавленных библиотек. Если мы хотим удалить библиотеку, достаточно удалить узел нужной библиотеки
из libraries и сохранить файл. И библиотека будет удалена из проекта.


Аналогично мы можем изменить даные библиотеки, например, изменить версию или расположения, и затем после сохранения файла
все изменения будут применены к проекту.
...
**Источник:** [https://metanit.com/sharp/aspnet5/13.7.php](https://metanit.com/sharp/aspnet5/13.7.php)
