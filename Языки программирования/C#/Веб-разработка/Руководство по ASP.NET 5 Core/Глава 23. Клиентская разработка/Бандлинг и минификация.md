...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Глава 23. Клиентская разработка]] / Бандлинг и минификация

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 22. ASP.NET Core Identity/Инициализация БД ролями и пользователями|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 23. Клиентская разработка/Менеджер Libman|Вперёд]]
...
[ссылке](https://visualstudiogallery.msdn.microsoft.com/9ec27da7-e24b-4d56-8064-fd7e88ac1c40).
...
![BundlerMinifier в ASP.NET Core](https://metanit.com./pics/bundle1.png)
...
![Автоматизация BundlerMinifier в ASP.NET Core](https://metanit.com./pics/bundle2.png)
...
![Bundling в ASP.NET Core MVC](https://metanit.com./pics/bundle4.png)
...
![Task Runner Explorer в Visual Studio 2019](https://metanit.com./pics/bundle3.png)
...
![Подключение бандлов стилей и скриптов в ASP.NET Core MVC](https://metanit.com./pics/bundle5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/13.6.php](https://metanit.com/sharp/aspnet5/13.6.php)
