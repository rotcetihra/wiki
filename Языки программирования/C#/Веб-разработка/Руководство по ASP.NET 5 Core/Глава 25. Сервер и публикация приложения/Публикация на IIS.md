...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения|Глава 25. Сервер и публикация приложения]] / Публикация на IIS

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения/Сервер|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения/Установка приложения в виде службы Windows|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 26.03.2018
...
Как правило, для хостирования приложения будет применяться один из внешних хостингов, список которых можно посмотреть [здесь](//metanit.com/sharp/articles/mvc/6.php).
...
![Публикация приложения ASP.NET Core в Visual Studio](https://metanit.com./pics/publish1.png)


И перед нами откроется окно публикации приложения:
![Публикация в приложения ASP.NET Core MVC на IIS](https://metanit.com./pics/publish6.png)
...
![Публикация в файловой системе приложения ASP.NET Core MVC](https://metanit.com./pics/publish7.png)
...
![Включение IIS на ОС Windows](https://metanit.com./pics/iis1.png)
...
Затем нам необходимо установить специальный пакет .NET Core Windows Server Hosting. Его можно найти, перейдя на страницу [https://www.microsoft.com/net/download/all](https://www.microsoft.com/net/download/all).
Далее на этой странице надо выбрать нужную версию .NET Core Runtime (.NET Core Runtime > .NET Core Runtime x.y.z. Далее
на странице выбранной версии .NET Core Runtime перейти к подразделу Windows и выбрать Server Hosting Installer.
...
Данный модуль, как говорилось выше, как раз и создает проксирование между IIS и сервером Kestrel.
...
![Диспетчер служб IIS в Windows](https://metanit.com./pics/iis2.png)
...
![Добавление приложения на IIS](https://metanit.com./pics/iis3.png)
...
![Пул приложений в IIS](https://metanit.com./pics/iis4.png)


В открывшемся окне для параметра Версия среды CLR .NET установим значение Без управляемого кода:
![Настройка среды пула приложений в IIS](https://metanit.com./pics/iis5.png)


После этого пул будет перезапущен, и мы сможем обращаться к нашему приложению по адресу localhost.
![Развертывание приложения ASP.NET Core на IIS](https://metanit.com./pics/iis6.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/20.1.php](https://metanit.com/sharp/aspnet5/20.1.php)
