...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения|Глава 25. Сервер и публикация приложения]] / Установка приложения в виде службы Windows

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения/Публикация на IIS|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 25. Сервер и публикация приложения|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 26. Тестирование/Введение в юнит-тесты|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 12.06.2018
...
![ASP.NET Core app as a Windows Service](https://metanit.com./pics/service1.png)
...
![Установка приложения ASP NET Core в виде службы](https://metanit.com./pics/service2.png)
...
![Приложение Asp.Net Core в виде службы Windows](https://metanit.com./pics/service3.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/20.2.php](https://metanit.com/sharp/aspnet5/20.2.php)
