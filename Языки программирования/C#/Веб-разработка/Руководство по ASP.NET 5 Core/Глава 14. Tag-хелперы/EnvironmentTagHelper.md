...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Глава 14. Tag-хелперы]] / EnvironmentTagHelper

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/Tag-хелперы форм|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/CacheTagHelper|Вперёд]]
...
Атрибут `names` через запятую позволяет перечислить, к каким состояниям среды приложения применяется этот тег.
...
значение "Development". В частности, мы можем увидеть ее значение, открыв свойства проекта и далее вкладку Debug:
![environmenttaghelper in ASP.NET Core](https://metanit.com./pics/environmenttaghelper.png)
...
![Переменная ASPNETCORE_ENVIRONMENT в ASP.NET Core](https://metanit.com./pics/environmenttaghelper1.png)
...
Кроме окна свойств проекта мы можем поменять значение ASPNETCORE_ENVIRONMENT для определенного профиля в файле launchSettings.json,
который находится в проекте в папке Properties и который по умолчанию выглядит примерно так:
...
Здесь мы можем поменять значение `"ASPNETCORE_ENVIRONMENT"` на любое предпочтительное. При этом обращаю внимание, что это значение
...
![Profile ASPNETCORE_ENVIRONMENT in ASP.NET Core](https://metanit.com./pics/environmenttaghelper2.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/10.6.php](https://metanit.com/sharp/aspnet5/10.6.php)
