...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Глава 14. Tag-хелперы]] / Создание tag-хелперов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/CacheTagHelper|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/Управление выводом tag-хелпера|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 06.12.2019
...
Для примера создадим какой-нибудь простейший тег-хелпер. Допустим, пусть он будет выводить текущее время. Для создания хелпера вначале создадим новый проект ASP.NET Core по типу ASP.NET Core Web App (Model-View-Controller). И затем добавим в него новую папку, которую назовем TagHelpers.
Далее в эту папку добавим новый класс TimerTagHelper:
...
![Создание taghelper в ASP.NET Core MVC](https://metanit.com./pics/customtaghelper2.png)
...
Чтобы задействовать класс хелпера в представлении, нам надо подключить его функциональность в представление. Для этого изменим представление
Views/_ViewImports.cshtml следующим образом:
...
Для добавления хелпера используется директива addTagHelper. Директива использует синтаксис подстановочных знаков,
определяя, какие tag-хелперы будут загружаться в представление. И также указывается сборка, которая содержит классы хелперы. То есть директива
...
Здесь первая часть до запятой (в данном случае символ звездочки) указывает, какие tag-хелперы будут загружаться в представление (символ
...
сборка TagHelpersApp (так как хелперы определены в текущем проекте).
...
![Создание tag helper в ASP.NET Core MVC](https://metanit.com./pics/customtaghelper.png)
...
![TagHelper in ASP.NET Core](https://metanit.com./pics/customtaghelper1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/10.8.php](https://metanit.com/sharp/aspnet5/10.8.php)
