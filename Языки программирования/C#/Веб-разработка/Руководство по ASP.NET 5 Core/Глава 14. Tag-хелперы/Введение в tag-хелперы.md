...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Глава 14. Tag-хелперы]] / Введение в tag-хелперы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 13. HTML-хелперы/URL-хелперы|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/AnchorTagHelper|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 02.12.2019
...
Tag-хелперы представляют собой функциональность, предназначенную для генерации HTML-разметки. Tag-хелперы используются в представлениях и
...
![Tag хелперы в ASP.NET MVC Core](https://metanit.com./pics/taghelper1.png)
...
Проект ASP.NET MVC Core уже по умолчанию подключает функциональность tag-хелперов в представления с помощью
установки в файле _ViewImports.cshtml следующей директивы:
...
Первый параметр директивы указывает на tag-хелперы, которые будут доступны во всех представлениях из папки Views, а второй параметр определяет
...
По умолчанию эта директива определяется в файле _ViewImports.cshtml, который находится в папке Views. Однако мы можем конкретизировать
применение хелперов к определенной группе представлений. Например, если у нас есть каталог Views/Home - специально для представлений для контроллера HomeController,
и мы хотим применить только к ним определенные хелперы. В этом случае мы можем добавить файл __ViewImports.cshtml_ непосредственно в этот каталог.
...
Эта директива также определяется в файле _ViewImports.cshtml.
...
**Источник:** [https://metanit.com/sharp/aspnet5/10.1.php](https://metanit.com/sharp/aspnet5/10.1.php)
