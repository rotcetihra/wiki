...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Глава 14. Tag-хелперы]] / Tag-хелперы и сложные объекты и коллекции

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы/Атрибут HtmlTargetElement|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 14. Tag-хелперы|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 15. View Component/Определение компонента представлений|Вперёд]]
...
![](https://metanit.com./pics/3.1.png)
...
будет соответствовать тег `user-info`. При запуске приложение сгенерирует разметку для вывода информации об объекте User:
![Tag Helper и модели в ASP.NET Core MVC](https://metanit.com./pics/3.2.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/10.9.php](https://metanit.com/sharp/aspnet5/10.9.php)
