...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 33. Дополнительные статьи|Глава 33. Дополнительные статьи]] / Отправка email в ASP.NET Core

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 32. React.JS/Взаимодействие React.JS и ASP.NET Core|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 33. Дополнительные статьи|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 33. Дополнительные статьи/Загрузка файлов на сервер|Вперёд]]
...
![MailKit в ASP.NET Core](https://metanit.com./pics/email8.png)
...
При подключении в метод `ConnectAsync()` передаются smtp-адрес сервера, номер порта, и логическое значение, указывающее, будет ли применяться SSL. В данном случае
...
**Источник:** [https://metanit.com/sharp/aspnet5/21.1.php](https://metanit.com/sharp/aspnet5/21.1.php)
