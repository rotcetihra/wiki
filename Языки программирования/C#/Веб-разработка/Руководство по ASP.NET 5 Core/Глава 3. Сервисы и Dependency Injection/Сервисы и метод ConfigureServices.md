...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Глава 3. Сервисы и Dependency Injection]] / Сервисы и метод ConfigureServices

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 2. Основы ASP.NET Core/Работа с HTTPS|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection/Создание своих сервисов|Вперёд]]
...
И если раньше в ASP.NET 4 и других предыдщих версиях надо было использовать различные внешние IoC-контейнеры для установки зависимостей,
...
интерфейсом IServiceProvider. А сами зависимости еще называются сервисами, собственно поэтому контейнер можно назвать
...
![Новый проект ASP.NET Core для Dependency Injection](https://metanit.com./pics/di.png)


За установку сервисов в приложении отвечает метод ConfigureServices, определенный в классе Startup. В проекте Empty этот метод
фактически пустой:
...
![Сервисы в ASP.NET Core](https://metanit.com./pics/di1.png)


Как видно на скриншоте, в коллекции IServiceCollection 78 сервиса, который мы можем использовать в приложении. Это такие сервисы, как ILogger<T>,
...
в любой части приложения. Например, в том же пустом проекте следующее определение метода Configure:
...
Через параметры метода Configure можно получить добавленные в приложении сервисы и, в частности, через параметр передается сервис IWebHostEnvironment,
который используется для определения окружения.
...
![Получение всех сервисов их IServiceCollection ASP.NET Core](https://metanit.com./pics/di3.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/6.1.php](https://metanit.com/sharp/aspnet5/6.1.php)
