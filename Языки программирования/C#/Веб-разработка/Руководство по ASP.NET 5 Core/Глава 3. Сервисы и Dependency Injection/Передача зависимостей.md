...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Глава 3. Сервисы и Dependency Injection]] / Передача зависимостей

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection/Создание своих сервисов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection/Жизненный цикл объектов при внедрении зависимостей|Вперёд]]
...
Встроенная в ASP.NET Core система внедрения зависимостей использует конструкторы классов для передачи всех зависимостей. Соответственно
в конструкторе контроллера мы можем получить зависимость. Конструкторы являются наиболее предпочтительным вариантом для получения зависимостей.
...
конкретный класс, то метод `services.AddTransient` типизируется одним этим типом MessageService. То есть классы, использующие сервисы, сами
...
в рамках ASP.NET Core в принципе мы можем использовать подобную функциональность.
...
- __[Видеокурс по ASP.NET Core. 13. Получение сервисов и Dependency Injection](https://www.youtube.com/watch?v=J2RKFhVQdrE)
...
**Источник:** [https://metanit.com/sharp/aspnet5/6.4.php](https://metanit.com/sharp/aspnet5/6.4.php)
