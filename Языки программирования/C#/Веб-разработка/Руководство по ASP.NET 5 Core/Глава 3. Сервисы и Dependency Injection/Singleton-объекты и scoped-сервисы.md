...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Глава 3. Сервисы и Dependency Injection]] / Singleton-объекты и scoped-сервисы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection/Применение сервисов в middleware|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 3. Сервисы и Dependency Injection|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Основы конфигурации|Вперёд]]
...
![Cannot resolve scoped service from root provider в ASP.NET Core 2](https://metanit.com./pics/dierror1.png)
...
![Cannot resolve from root provider because it requires scoped service](https://metanit.com./pics/dierror2.png)
...
![Cannot consume scoped service from singleton in ASP.NET Core](https://metanit.com./pics/dierror3.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/6.5.php](https://metanit.com/sharp/aspnet5/6.5.php)
