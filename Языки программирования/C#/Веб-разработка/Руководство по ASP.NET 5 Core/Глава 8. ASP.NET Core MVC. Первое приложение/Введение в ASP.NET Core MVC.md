...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение|Глава 8. ASP.NET Core MVC. Первое приложение]] / Введение в ASP.NET Core MVC

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 7. Маршрутизация/Создание своего маршрута|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение/Добавление MVC в пустой проект|Вперёд]]
...
![Фреймворк ASP.NET MVC](https://metanit.com./pics/mvc1.png)
![Первый проект на ASP.NET MVC Core](https://metanit.com./pics/mvc2.png)
...
![Структура проекта ASP.NET MVC Core](https://metanit.com./pics/mvcstructure1.png)
...
![Первый проект на ASP.NET MVC Core](https://metanit.com./pics/mvc5.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/3.1.php](https://metanit.com/sharp/aspnet5/3.1.php)
