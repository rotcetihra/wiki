...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение|Глава 8. ASP.NET Core MVC. Первое приложение]] / Добавление мастер-страницы и стилизации

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение/Добавление методов контроллера и представлений|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 8. ASP.NET Core MVC. Первое приложение|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Контроллеры и их действия|Вперёд]]
...
![Layout в ASP.NET MVC Core](https://metanit.com./pics/mvc16.png)


Мастер-страница предствляет обычное представление, в которое включает в себя другие отдельные представления. Откроем файл __Layout.cshtml_
...
Вначале подключаются стили библиотеки Bootstrap, которая по умолчанию уже имеется в проекте в папке _wwwroot/lib/bootstrap/dist/css/_.
...
Для создания таблицы здесь используется класс bootstrap `table-condensed`. Поскольку данное представление будет внедряться в мастер-страницу, то соответственно
все стили и скрипты на мастер-страницы для представления Index.cshtml также будут доступны.


Представление _Buy.cshtml_:
...
![Применение стилизации в ASP.NET MVC Core](https://metanit.com./pics/mvc17.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/3.5.php](https://metanit.com/sharp/aspnet5/3.5.php)
