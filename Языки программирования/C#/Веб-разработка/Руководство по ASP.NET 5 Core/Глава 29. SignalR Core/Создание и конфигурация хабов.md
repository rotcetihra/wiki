...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Глава 29. SignalR Core]] / Создание и конфигурация хабов

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/SignalR Core. Первое приложение|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/Клиент javascript|Вперёд]]
...
Ключевой сущностью в SignalR, через которую клиенты обмениваются сообщеними с сервером и между собой, является хаб (hub),
который представляет некоторый класс, унаследованный от абстрактного класса Microsoft.AspNetCore.SignalR.Hub.
...
Сам по себе SignalR не будет работать, чтобы хаб был доступен для использования, в методе ConfigureServices() класса
Startup вызывает метод `services.AddSignalR()`:
...
Перегузка этого метода принимает в качестве параметра делегат Action, который имеет параметр типа HubOptions. Данный параметр
...
Чтобы сервер мог сопоставить запросы с определенным хабом, в методе Configure() класса Startup
для сопоставления определенного маршрута с определенным хабом вызывается метод MapHub():
...
**Источник:** [https://metanit.com/sharp/aspnet5/30.2.php](https://metanit.com/sharp/aspnet5/30.2.php)
