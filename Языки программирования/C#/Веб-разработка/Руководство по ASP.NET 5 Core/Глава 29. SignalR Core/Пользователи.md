...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Глава 29. SignalR Core]] / Пользователи

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/Аутентификация и авторизация с помощью токенов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/Группы|Вперёд]]
...
В данном случае он возвращает значение `User.Identity.Name`. Здесь `connection.User` - это текущий пользователь. Здесь
...
или так `Context.User.Identity.Name` или так `Context.UserIdentifier`. Далее сообщение отправляется
...
![Управление пользователями в SignalR в ASP.NET Core](https://metanit.com./pics/signalr18.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/30.10.php](https://metanit.com/sharp/aspnet5/30.10.php)
