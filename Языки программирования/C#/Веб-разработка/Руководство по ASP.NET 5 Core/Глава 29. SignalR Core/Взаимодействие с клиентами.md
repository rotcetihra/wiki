...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Глава 29. SignalR Core]] / Взаимодействие с клиентами

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/Контекст хаба, подключение и отключение клиентов|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 29. SignalR Core/IHubContext|Вперёд]]
...
![Отправка сообщений сервера клиенту в ASP NET Core SignalR](https://metanit.com./pics/signalr10.png)


А все остальные подключенные клиенты получат своего рода push-уведомление о произведенных действиях:
![Push уведомления в ASP NET Core SignalR](https://metanit.com./pics/signalr11.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/30.5.php](https://metanit.com/sharp/aspnet5/30.5.php)
