...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Глава 4. Конфигурация]] / Проекция конфигурации на классы

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Создание провайдера конфгурации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Передача конфигурации через IOptions|Вперёд]]
...
В ASP.NET Core мы можем не просто получать конфигурационные настройки в виде разрозненных пар ключ-значение, но и проецировать данные конфигурации
на классы C#.
...
Стоит отметить, что между конфигурацией в json и классом Person имеется соответствие по названию свойств, благодаря чему может осуществляться связка (регистр в данном случае роли не играет).
![Привязка конфигурации json и класса C# в ASP.NET Core](https://metanit.com./pics/config9.png)
...
![Привязка комплексных объектов из конфигурации json к классам C# в ASP.NET Core](https://metanit.com./pics/config8.png)
...
В примерах выше выполнялась привязка корневого объекта конфигурации, однако также можно осуществлять привязку отдельных секций. Например, выше в
файле json и xml была определена секция company, которая хранит компанию пользователя. Выполним привязку отдельно этой секции к объекту класса Company:
...
![Привязка секции конфигурации к объекту класса C# в ASP.NET Core](https://metanit.com./pics/config10.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.9.php](https://metanit.com/sharp/aspnet5/2.9.php)
