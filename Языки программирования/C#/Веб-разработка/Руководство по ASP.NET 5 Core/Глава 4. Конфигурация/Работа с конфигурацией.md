...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Глава 4. Конфигурация]] / Работа с конфигурацией

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Объединение конфигураций и установка сервиса IConfiguration|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Создание провайдера конфгурации|Вперёд]]
...
GetConnectionString(name): эквивалентен вызову `GetSection("ConnectionStrings")[name]` и предназначается непосредственно
...
вызвать у ней метод `GetSection()`. Если же секция содержит только значение, то оно доступно через свойство `Value`.
...
Используя выше рассмотренные методы, мы можем провести анализ всего файла конфигурации. Например,
пусть в проекте определен следующий конфигурационный файл project.json:
...
![Конфигурация json в ASP.NET Core MVC](https://metanit.com./pics/2.23.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.17.php](https://metanit.com/sharp/aspnet5/2.17.php)
