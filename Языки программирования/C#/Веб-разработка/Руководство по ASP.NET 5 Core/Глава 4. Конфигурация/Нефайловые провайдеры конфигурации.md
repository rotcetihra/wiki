...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Глава 4. Конфигурация]] / Нефайловые провайдеры конфигурации

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Основы конфигурации|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 4. Конфигурация/Файловые провайдеры конфигурации|Вперёд]]
...
Провайдер CommandLineConfigurationProvider обеспечивает передачу аргументов командной строки в конфигурацию приложения. Для применения этого провайдера у
объекта вызывается метод AddCommandLine(), в который передаются аргументы командной строки.
...
![Параметры конфигурации командной строки в ASP.NET Core](https://metanit.com./pics/config2.png)
...
![Установка конфигурации командной строки в ASP.NET Core](https://metanit.com./pics/config3.png)
...
cd в папку проекта. В моем случае это папка C:\Users\Eugene\Source\Repos\ASPNETCore\ConfigurationApp\ConfigurationApp.
...
![dotnet run и конфигурация командной строки в ASP.NET Core](https://metanit.com./pics/config4.png)


В итоге приложение подхватит переданные данные:
![CommandLineConfigurationProvider в ASP.NET Core](https://metanit.com./pics/config5.png)
...
Для его использования у объекта ConfigurationBuilder вызывается метод AddEnvironmentVariables(). Однако в реальности
...
Провайдер MemoryConfigurationProvider позволяет использовать в качестве конфигурации коллекцию IEnumerable<<string, string>>,
...
**Источник:** [https://metanit.com/sharp/aspnet5/2.16.php](https://metanit.com/sharp/aspnet5/2.16.php)
