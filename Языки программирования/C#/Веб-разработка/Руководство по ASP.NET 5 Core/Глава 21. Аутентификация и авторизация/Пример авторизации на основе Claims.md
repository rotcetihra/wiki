...
Для тестирования авторизации добавим в папку Controllers новый контроллер AccountController,
который будет выполнять регистрацию пользователей.
...
![Авторизация claims в ASP.NET Core](https://metanit.com./pics/claims3.png)
...
Здесь метод `Index` доступен только для тех пользователей, которые удовлетворяют политике "OnlyForLondon", а метод About - для пользователей,
...
![Создание нового пользователя в ASP.NET Core](https://metanit.com./pics/claims1.png)


И после регистрации перейдем к методу Index контроллера HomeController:
![Claims based authorization in ASP.NET Core](https://metanit.com./pics/claims2.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/15.7.php](https://metanit.com/sharp/aspnet5/15.7.php)
