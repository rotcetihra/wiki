...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Глава 10. Представления]] / Файл _ViewImports.cshtml

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Мастер-страницы|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Частичные представления|Вперёд]]
...
Данное руководство устарело. Актуальное руководство: [Руководство по ASP.NET Core 7](https://metanit.com/sharp/aspnet6/)Последнее обновление: 13.03.2017
...
![_ViewImports.cshtml в ASP.NET Core](https://metanit.com./pics/views14.png)
...
Вторая строка добавляет функциональность встроенных tag-хелперов из пространства имен `Microsoft.AspNetCore.Mvc.TagHelpers`. Про tag-хелперы
[далее](10.1.php) рассказывается более подробно. Сейчас же нас интересует прежде всего первая строка.
...
![Подключение типов в представление в ASP.NET Core MVC](https://metanit.com./pics/views15.png)
...
Чтобы использовать тип Phone в представлении, мы вынуждены импортировать с помощью директивы `using` пространство имен, где этот тип определен.
...
Для каждой группы представлений в одной папке мы можем определить свой файл _ViewImports.cshtml. Так пускай, в проекте будет добавлен
новый контроллер OtherController, в папке Views для его представлений будет добавлена подпапка Other:
![ViewImport in ASP.NET Core MVC](https://metanit.com./pics/views16.png)


В эту папку Views/Other добавим новый файл _ViewImports.cshtml. Для его добавления можно выбрать спецальный шаблон:
![ViewImport Template in ASP.NET Core](https://metanit.com./pics/views17.png)


И теперь все директивы и выражения из файла Views/Other/_ViewImports.cshtml будут применяться к представлениям только из папки Views/Other.
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.9.php](https://metanit.com/sharp/aspnet5/7.9.php)
