...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Глава 10. Представления]] / Частичные представления

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Файл _ViewImports.cshtml|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Внедрение зависимостей в представления|Вперёд]]
...
В приложениях на ASP.NET MVC кроме обычных представлений и мастер-страниц можно также использовать частичные представления или partial views.
...
Теперь обратимся к методу GetMessage
как к обычному действию контроллера, и оно нам вернет частичное представление:
![Частичные представления в ASP.NET MVC Core](https://metanit.com./pics/views5.png)
...
![Partial Views in ASP.NET MVC Core](https://metanit.com./pics/views6.png)
...
Теперь изменим частичное представление _GetMessage.cshtml:
...
![](https://metanit.com./pics/views7.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.5.php](https://metanit.com/sharp/aspnet5/7.5.php)
