...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Глава 10. Представления]] / Введение в представления

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 9. Контроллеры/Передача зависимостей в контроллер|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Движок представлений Razor|Вперёд]]
...
![Представления в ASP.NET MVC Core](https://metanit.com./pics/views2.png)
...
![Добавление представления в ASP.NET MVC Core](https://metanit.com./pics/views3.png)
...
В этом случае метод Index будет использовать представление _Views/Home/About.cshtml_. Если же представление находится в другой папке,
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.1.php](https://metanit.com/sharp/aspnet5/7.1.php)
