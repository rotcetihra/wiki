...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Глава 10. Представления]] / Внедрение зависимостей в представления

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Частичные представления|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Работа с формами|Вперёд]]
...
![Внедрение зависимостей в представления в ASP.NET Core](https://metanit.com./pics/views8.png)
...
![Dependency Injection in Views in ASP.NET Core](https://metanit.com./pics/views1.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.7.php](https://metanit.com/sharp/aspnet5/7.7.php)
