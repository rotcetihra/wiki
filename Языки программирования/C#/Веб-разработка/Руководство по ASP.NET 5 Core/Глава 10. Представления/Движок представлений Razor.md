...
[[Языки программирования/C#|C#]] / [[Языки программирования/C#/Веб-разработка|Веб-разработка]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core|Руководство по ASP.NET 5 Core]] / [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Глава 10. Представления]] / Движок представлений Razor

[[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Введение в представления|Назад]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления|Содержание]] | [[Языки программирования/C#/Веб-разработка/Руководство по ASP.NET 5 Core/Глава 10. Представления/Передача данных в представление|Вперёд]]
...
![Синтаксис движка представлений Razor](https://metanit.com./pics/razor1.png)
...
![Блоки кода в Razor в ASP.NET MVC](https://metanit.com./pics/razor2.png)
...
**Источник:** [https://metanit.com/sharp/aspnet5/7.2.php](https://metanit.com/sharp/aspnet5/7.2.php)
