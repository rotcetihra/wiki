...
- 6 статей главы 1 раздела «Хеш таблицы» — копии статей с сайта metanit.com: «Введение в хеш-таблицы» (1.1.php), «Хеш-функция» (1.2.php), «Определение хеш-таблицы» (1.3.php), «Размер хеш-таблицы» (1.4.php), «Операции с хеш-таблицами» (1.5.php), «Коллизии. Стратегия цепочки и связанных списков» (1.6.php).
